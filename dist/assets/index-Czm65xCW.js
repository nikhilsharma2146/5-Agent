...
`).replace(Ad,``)}function Md(e,t){return t=jd(t),jd(e)===t}function $(e,t,n,r,a,o){switch(n){case`children`:typeof r==`string`?t===`body`||t===`textarea`&&r===``||en(e,r):(typeof r==`number`||typeof r==`bigint`)&&t!==`body`&&en(e,``+r);break;case`className`:Rt(e,`class`,r);break;case`tabIndex`:Rt(e,`tabindex`,r);break;case`dir`:case`role`:case`viewBox`:case`width`:case`height`:Rt(e,n,r);break;case`style`:rn(e,r,o);break;case`data`:if(t!==`object`){Rt(e,`data`,r);break}case`src`:case`href`:if(r===``&&(t!==`a`||n!==`href`)){e.removeAttribute(n);break}if(r==null||typeof r==`function`||typeof r==`symbol`||typeof r==`boolean`){e.removeAttribute(n);break}r=cn(``+r),e.setAttribute(n,r);break;case`action`:case`formAction`:if(typeof r==`function`){e.setAttribute(n,`javascript:throw new Error('A React form was unexpectedly submitted. If you called form.submit() manually, consider using form.requestSubmit() instead. If you\\'re trying to use event.stopPropagation() in a submit event handler, consider also calling event.preventDefault().')`);break}else typeof o==`function`&&(n===`formAction`?(t!==`input`&&$(e,t,`name`,a.name,a,null),$(e,t,`formEncType`,a.formEncType,a,null),$(e,t,`formMethod`,a.formMethod,a,null),$(e,t,`formTarget`,a.formTarget,a,null)):($(e,t,`encType`,a.encType,a,null),$(e,t,`method`,a.method,a,null),$(e,t,`target`,a.target,a,null)));if(r==null||typeof r==`symbol`||typeof r==`boolean`){e.removeAttribute(n);break}r=cn(``+r),e.setAttribute(n,r);break;case`onClick`:r!=null&&(e.onclick=ln);break;case`onScroll`:r!=null&&Q(`scroll`,e);break;case`onScrollEnd`:r!=null&&Q(`scrollend`,e);break;case`dangerouslySetInnerHTML`:if(r!=null){if(typeof r!=`object`||!(`__html`in r))throw Error(i(61));if(n=r.__html,n!=null){if(a.children!=null)throw Error(i(60));e.innerHTML=n}}break;case`multiple`:e.multiple=r&&typeof r!=`function`&&typeof r!=`symbol`;break;case`muted`:e.muted=r&&typeof r!=`function`&&typeof r!=`symbol`;break;case`suppressContentEditableWarning`:case`suppressHydrationWarning`:case`defaultValue`:case`defaultChecked`:case`innerHTML`:case`ref`:break;case`autoFocus`:break;case`xlinkHref`:if(r==null||typeof r==`function`||typeof r==`boolean`||typeof r==`symbol`){e.removeAttribute(`xlink:href`);break}n=cn(``+r),e.setAttributeNS(`http://www.w3.org/1999/xlink`,`xlink:href`,n);break;case`contentEditable`:case`spellCheck`:case`draggable`:case`value`:case`autoReverse`:case`externalResourcesRequired`:case`focusable`:case`preserveAlpha`:r!=null&&typeof r!=`function`&&typeof r!=`symbol`?e.setAttribute(n,``+r):e.removeAttribute(n);break;case`inert`:case`allowFullScreen`:case`async`:case`autoPlay`:case`controls`:case`default`:case`defer`:case`disabled`:case`disablePictureInPicture`:case`disableRemotePlayback`:case`formNoValidate`:case`hidden`:case`loop`:case`noModule`:case`noValidate`:case`open`:case`playsInline`:case`readOnly`:case`required`:case`reversed`:case`scoped`:case`seamless`:case`itemScope`:r&&typeof r!=`function`&&typeof r!=`symbol`?e.setAttribute(n,``):e.removeAttribute(n);break;case`capture`:case`download`:!0===r?e.setAttribute(n,``):!1!==r&&r!=null&&typeof r!=`function`&&typeof r!=`symbol`?e.setAttribute(n,r):e.removeAttribute(n);break;case`cols`:case`rows`:case`size`:case`span`:r!=null&&typeof r!=`function`&&typeof r!=`symbol`&&!isNaN(r)&&1<=r?e.setAttribute(n,r):e.removeAttribute(n);break;case`rowSpan`:case`start`:r==null||typeof r==`function`||typeof r==`symbol`||isNaN(r)?e.removeAttribute(n):e.setAttribute(n,r);break;case`popover`:Q(`beforetoggle`,e),Q(`toggle`,e),Lt(e,`popover`,r);break;case`xlinkActuate`:zt(e,`http://www.w3.org/1999/xlink`,`xlink:actuate`,r);break;case`xlinkArcrole`:zt(e,`http://www.w3.org/1999/xlink`,`xlink:arcrole`,r);break;case`xlinkRole`:zt(e,`http://www.w3.org/1999/xlink`,`xlink:role`,r);break;case`xlinkShow`:zt(e,`http://www.w3.org/1999/xlink`,`xlink:show`,r);break;case`xlinkTitle`:zt(e,`http://www.w3.org/1999/xlink`,`xlink:title`,r);break;case`xlinkType`:zt(e,`http://www.w3.org/1999/xlink`,`xlink:type`,r);break;case`xmlBase`:zt(e,`http://www.w3.org/XML/1998/namespace`,`xml:base`,r);break;case`xmlLang`:zt(e,`http://www.w3.org/XML/1998/namespace`,`xml:lang`,r);break;case`xmlSpace`:zt(e,`http://www.w3.org/XML/1998/namespace`,`xml:space`,r);break;case`is`:Lt(e,`is`,r);break;case`innerText`:case`textContent`:break;default:(!(2<n.length)||n[0]!==`o`&&n[0]!==`O`||n[1]!==`n`&&n[1]!==`N`)&&(n=on.get(n)||n,Lt(e,n,r))}}function Nd(e,t,n,r,a,o){switch(n){case`style`:rn(e,r,o);break;case`dangerouslySetInnerHTML`:if(r!=null){if(typeof r!=`object`||!(`__html`in r))throw Error(i(61));if(n=r.__html,n!=null){if(a.children!=null)throw Error(i(60));e.innerHTML=n}}break;case`children`:typeof r==`string`?en(e,r):(typeof r==`number`||typeof r==`bigint`)&&en(e,``+r);break;case`onScroll`:r!=null&&Q(`scroll`,e);break;case`onScrollEnd`:r!=null&&Q(`scrollend`,e);break;case`onClick`:r!=null&&(e.onclick=ln);break;case`suppressContentEditableWarning`:case`suppressHydrationWarning`:case`innerHTML`:case`ref`:break;case`innerText`:case`textContent`:break;default:if(!At.hasOwnProperty(n))a:{if(n[0]===`o`&&n[1]===`n`&&(a=n.endsWith(`Capture`),t=n.slice(2,a?n.length-7:void 0),o=e[_t]||null,o=o==null?null:o[n],typeof o==`function`&&e.removeEventListener(t,o,a),typeof r==`function`)){typeof o!=`function`&&o!==null&&(n in e?e[n]=null:e.hasAttribute(n)&&e.removeAttribute(n)),e.addEventListener(t,r,a);break a}n in e?e[n]=r:!0===r?e.setAttribute(n,``):Lt(e,n,r)}}}function Pd(e,t,n){switch(t){case`div`:case`span`:case`svg`:case`path`:case`a`:case`g`:case`p`:case`li`:break;case`img`:Q(`error`,e),Q(`load`,e);var r=!1,a=!1,o;for(o in n)if(n.hasOwnProperty(o)){var s=n[o];if(s!=null)switch(o){case`src`:r=!0;break;case`srcSet`:a=!0;break;case`children`:case`dangerouslySetInnerHTML`:throw Error(i(137,t));default:$(e,t,o,s,n,null)}}a&&$(e,t,`srcSet`,n.srcSet,n,null),r&&$(e,t,`src`,n.src,n,null);return;case`input`:Q(`invalid`,e);var c=o=s=a=null,l=null,u=null;for(r in n)if(n.hasOwnProperty(r)){var d=n[r];if(d!=null)switch(r){case`name`:a=d;break;case`type`:s=d;break;case`checked`:l=d;break;case`defaultChecked`:u=d;break;case`value`:o=d;break;case`defaultValue`:c=d;break;case`children`:case`dangerouslySetInnerHTML`:if(d!=null)throw Error(i(137,t));break;default:$(e,t,r,d,n,null)}}Yt(e,o,c,l,u,s,a,!1);return;case`select`:for(a in Q(`invalid`,e),r=s=o=null,n)if(n.hasOwnProperty(a)&&(c=n[a],c!=null))switch(a){case`value`:o=c;break;case`defaultValue`:s=c;break;case`multiple`:r=c;default:$(e,t,a,c,n,null)}t=o,n=s,e.multiple=!!r,t==null?n!=null&&Zt(e,!!r,n,!0):Zt(e,!!r,t,!1);return;case`textarea`:for(s in Q(`invalid`,e),o=a=r=null,n)if(n.hasOwnProperty(s)&&(c=n[s],c!=null))switch(s){case`value`:r=c;break;case`defaultValue`:a=c;break;case`children`:o=c;break;case`dangerouslySetInnerHTML`:if(c!=null)throw Error(i(91));break;default:$(e,t,s,c,n,null)}$t(e,r,a,o);return;case`option`:for(l in n)if(n.hasOwnProperty(l)&&(r=n[l],r!=null))switch(l){case`selected`:e.selected=r&&typeof r!=`function`&&typeof r!=`symbol`;break;default:$(e,t,l,r,n,null)}return;case`dialog`:Q(`beforetoggle`,e),Q(`toggle`,e),Q(`cancel`,e),Q(`close`,e);break;case`iframe`:case`object`:Q(`load`,e);break;case`video`:case`audio`:for(r=0;r<_d.length;r++)Q(_d[r],e);break;case`image`:Q(`error`,e),Q(`load`,e);break;case`details`:Q(`toggle`,e);break;case`embed`:case`source`:case`link`:Q(`error`,e),Q(`load`,e);case`area`:case`base`:case`br`:case`col`:case`hr`:case`keygen`:case`meta`:case`param`:case`track`:case`wbr`:case`menuitem`:for(u in n)if(n.hasOwnProperty(u)&&(r=n[u],r!=null))switch(u){case`children`:case`dangerouslySetInnerHTML`:throw Error(i(137,t));default:$(e,t,u,r,n,null)}return;default:if(an(t)){for(d in n)n.hasOwnProperty(d)&&(r=n[d],r!==void 0&&Nd(e,t,d,r,n,void 0));return}}for(c in n)n.hasOwnProperty(c)&&(r=n[c],r!=null&&$(e,t,c,r,n,null))}function Fd(e,t,n,r){switch(t){case`div`:case`span`:case`svg`:case`path`:case`a`:case`g`:case`p`:case`li`:break;case`input`:var a=null,o=null,s=null,c=null,l=null,u=null,d=null;for(m in n){var f=n[m];if(n.hasOwnProperty(m)&&f!=null)switch(m){case`checked`:break;case`value`:break;case`defaultValue`:l=f;default:r.hasOwnProperty(m)||$(e,t,m,null,r,f)}}for(var p in r){var m=r[p];if(f=n[p],r.hasOwnProperty(p)&&(m!=null||f!=null))switch(p){case`type`:o=m;break;case`name`:a=m;break;case`checked`:u=m;break;case`defaultChecked`:d=m;break;case`value`:s=m;break;case`defaultValue`:c=m;break;case`children`:case`dangerouslySetInnerHTML`:if(m!=null)throw Error(i(137,t));break;default:m!==f&&$(e,t,p,m,r,f)}}Jt(e,s,c,l,u,d,o,a);return;case`select`:for(o in m=s=c=p=null,n)if(l=n[o],n.hasOwnProperty(o)&&l!=null)switch(o){case`value`:break;case`multiple`:m=l;default:r.hasOwnProperty(o)||$(e,t,o,null,r,l)}for(a in r)if(o=r[a],l=n[a],r.hasOwnProperty(a)&&(o!=null||l!=null))switch(a){case`value`:p=o;break;case`defaultValue`:c=o;break;case`multiple`:s=o;default:o!==l&&$(e,t,a,o,r,l)}t=c,n=s,r=m,p==null?!!r!=!!n&&(t==null?Zt(e,!!n,n?[]:``,!1):Zt(e,!!n,t,!0)):Zt(e,!!n,p,!1);return;case`textarea`:for(c in m=p=null,n)if(a=n[c],n.hasOwnProperty(c)&&a!=null&&!r.hasOwnProperty(c))switch(c){case`value`:break;case`children`:break;default:$(e,t,c,null,r,a)}for(s in r)if(a=r[s],o=n[s],r.hasOwnProperty(s)&&(a!=null||o!=null))switch(s){case`value`:p=a;break;case`defaultValue`:m=a;break;case`children`:break;case`dangerouslySetInnerHTML`:if(a!=null)throw Error(i(91));break;default:a!==o&&$(e,t,s,a,r,o)}Qt(e,p,m);return;case`option`:for(var h in n)if(p=n[h],n.hasOwnProperty(h)&&p!=null&&!r.hasOwnProperty(h))switch(h){case`selected`:e.selected=!1;break;default:$(e,t,h,null,r,p)}for(l in r)if(p=r[l],m=n[l],r.hasOwnProperty(l)&&p!==m&&(p!=null||m!=null))switch(l){case`selected`:e.selected=p&&typeof p!=`function`&&typeof p!=`symbol`;break;default:$(e,t,l,p,r,m)}return;case`img`:case`link`:case`area`:case`base`:case`br`:case`col`:case`embed`:case`hr`:case`keygen`:case`meta`:case`param`:case`source`:case`track`:case`wbr`:case`menuitem`:for(var g in n)p=n[g],n.hasOwnProperty(g)&&p!=null&&!r.hasOwnProperty(g)&&$(e,t,g,null,r,p);for(u in r)if(p=r[u],m=n[u],r.hasOwnProperty(u)&&p!==m&&(p!=null||m!=null))switch(u){case`children`:case`dangerouslySetInnerHTML`:if(p!=null)throw Error(i(137,t));break;default:$(e,t,u,p,r,m)}return;default:if(an(t)){for(var _ in n)p=n[_],n.hasOwnProperty(_)&&p!==void 0&&!r.hasOwnProperty(_)&&Nd(e,t,_,void 0,r,p);for(d in r)p=r[d],m=n[d],!r.hasOwnProperty(d)||p===m||p===void 0&&m===void 0||Nd(e,t,d,p,r,m);return}}for(var v in n)p=n[v],n.hasOwnProperty(v)&&p!=null&&!r.hasOwnProperty(v)&&$(e,t,v,null,r,p);for(f in r)p=r[f],m=n[f],!r.hasOwnProperty(f)||p===m||p==null&&m==null||$(e,t,f,p,r,m)}function Id(e){switch(e){case`css`:case`script`:case`font`:case`img`:case`image`:case`input`:case`link`:return!0;default:return!1}}function Ld(){if(typeof performance.getEntriesByType==`function`){for(var e=0,t=0,n=performance.getEntriesByType(`resource`),r=0;r<n.length;r++){var i=n[r],a=i.transferSize,o=i.initiatorType,s=i.duration;if(a&&s&&Id(o)){for(o=0,s=i.responseEnd,r+=1;r<n.length;r++){var c=n[r],l=c.startTime;if(l>s)break;var u=c.transferSize,d=c.initiatorType;u&&Id(d)&&(c=c.responseEnd,o+=u*(c<s?1:(s-l)/(c-l)))}if(--r,t+=8*(a+o)/(i.duration/1e3),e++,10<e)break}}if(0<e)return t/e/1e6}return navigator.connection&&(e=navigator.connection.downlink,typeof e==`number`)?e:5}var Rd=null,zd=null;function Bd(e){return e.nodeType===9?e:e.ownerDocument}function Vd(e){switch(e){case`http://www.w3.org/2000/svg`:return 1;case`http://www.w3.org/1998/Math/MathML`:return 2;default:return 0}}function Hd(e,t){if(e===0)switch(t){case`svg`:return 1;case`math`:return 2;default:return 0}return e===1&&t===`foreignObject`?0:e}function Ud(e,t){return e===`textarea`||e===`noscript`||typeof t.children==`string`||typeof t.children==`number`||typeof t.children==`bigint`||typeof t.dangerouslySetInnerHTML==`object`&&t.dangerouslySetInnerHTML!==null&&t.dangerouslySetInnerHTML.__html!=null}var Wd=null;function Gd(){var e=window.event;return e&&e.type===`popstate`?e===Wd?!1:(Wd=e,!0):(Wd=null,!1)}var Kd=typeof setTimeout==`function`?setTimeout:void 0,qd=typeof clearTimeout==`function`?clearTimeout:void 0,Jd=typeof Promise==`function`?Promise:void 0,Yd=typeof queueMicrotask==`function`?queueMicrotask:Jd===void 0?Kd:function(e){return Jd.resolve(null).then(e).catch(Xd)};function Xd(e){setTimeout(function(){throw e})}function Zd(e){return e===`head`}function Qd(e,t){var n=t,r=0;do{var i=n.nextSibling;if(e.removeChild(n),i&&i.nodeType===8)if(n=i.data,n===`/$`||n===`/&`){if(r===0){e.removeChild(i),Np(t);return}r--}else if(n===`$`||n===`$?`||n===`$~`||n===`$!`||n===`&`)r++;else if(n===`html`)pf(e.ownerDocument.documentElement);else if(n===`head`){n=e.ownerDocument.head,pf(n);for(var a=n.firstChild;a;){var o=a.nextSibling,s=a.nodeName;a[Ct]||s===`SCRIPT`||s===`STYLE`||s===`LINK`&&a.rel.toLowerCase()===`stylesheet`||n.removeChild(a),a=o}}else n===`body`&&pf(e.ownerDocument.body);n=i}while(n);Np(t)}function $d(e,t){var n=e;e=0;do{var r=n.nextSibling;if(n.nodeType===1?t?(n._stashedDisplay=n.style.display,n.style.display=`none`):(n.style.display=n._stashedDisplay||``,n.getAttribute(`style`)===``&&n.removeAttribute(`style`)):n.nodeType===3&&(t?(n._stashedText=n.nodeValue,n.nodeValue=``):n.nodeValue=n._stashedText||``),r&&r.nodeType===8)if(n=r.data,n===`/$`){if(e===0)break;e--}else n!==`$`&&n!==`$?`&&n!==`$~`&&n!==`$!`||e++;n=r}while(n)}function ef(e){var t=e.firstChild;for(t&&t.nodeType===10&&(t=t.nextSibling);t;){var n=t;switch(t=t.nextSibling,n.nodeName){case`HTML`:case`HEAD`:case`BODY`:ef(n),wt(n);continue;case`SCRIPT`:case`STYLE`:continue;case`LINK`:if(n.rel.toLowerCase()===`stylesheet`)continue}e.removeChild(n)}}function tf(e,t,n,r){for(;e.nodeType===1;){var i=n;if(e.nodeName.toLowerCase()!==t.toLowerCase()){if(!r&&(e.nodeName!==`INPUT`||e.type!==`hidden`))break}else if(!r)if(t===`input`&&e.type===`hidden`){var a=i.name==null?null:``+i.name;if(i.type===`hidden`&&e.getAttribute(`name`)===a)return e}else return e;else if(!e[Ct])switch(t){case`meta`:if(!e.hasAttribute(`itemprop`))break;return e;case`link`:if(a=e.getAttribute(`rel`),a===`stylesheet`&&e.hasAttribute(`data-precedence`)||a!==i.rel||e.getAttribute(`href`)!==(i.href==null||i.href===``?null:i.href)||e.getAttribute(`crossorigin`)!==(i.crossOrigin==null?null:i.crossOrigin)||e.getAttribute(`title`)!==(i.title==null?null:i.title))break;return e;case`style`:if(e.hasAttribute(`data-precedence`))break;return e;case`script`:if(a=e.getAttribute(`src`),(a!==(i.src==null?null:i.src)||e.getAttribute(`type`)!==(i.type==null?null:i.type)||e.getAttribute(`crossorigin`)!==(i.crossOrigin==null?null:i.crossOrigin))&&a&&e.hasAttribute(`async`)&&!e.hasAttribute(`itemprop`))break;return e;default:return e}if(e=cf(e.nextSibling),e===null)break}return null}function nf(e,t,n){if(t===``)return null;for(;e.nodeType!==3;)if((e.nodeType!==1||e.nodeName!==`INPUT`||e.type!==`hidden`)&&!n||(e=cf(e.nextSibling),e===null))return null;return e}function rf(e,t){for(;e.nodeType!==8;)if((e.nodeType!==1||e.nodeName!==`INPUT`||e.type!==`hidden`)&&!t||(e=cf(e.nextSibling),e===null))return null;return e}function af(e){return e.data===`$?`||e.data===`$~`}function of(e){return e.data===`$!`||e.data===`$?`&&e.ownerDocument.readyState!==`loading`}function sf(e,t){var n=e.ownerDocument;if(e.data===`$~`)e._reactRetry=t;else if(e.data!==`$?`||n.readyState!==`loading`)t();else{var r=function(){t(),n.removeEventListener(`DOMContentLoaded`,r)};n.addEventListener(`DOMContentLoaded`,r),e._reactRetry=r}}function cf(e){for(;e!=null;e=e.nextSibling){var t=e.nodeType;if(t===1||t===3)break;if(t===8){if(t=e.data,t===`$`||t===`$!`||t===`$?`||t===`$~`||t===`&`||t===`F!`||t===`F`)break;if(t===`/$`||t===`/&`)return null}}return e}var lf=null;function uf(e){e=e.nextSibling;for(var t=0;e;){if(e.nodeType===8){var n=e.data;if(n===`/$`||n===`/&`){if(t===0)return cf(e.nextSibling);t--}else n!==`$`&&n!==`$!`&&n!==`$?`&&n!==`$~`&&n!==`&`||t++}e=e.nextSibling}return null}function df(e){e=e.previousSibling;for(var t=0;e;){if(e.nodeType===8){var n=e.data;if(n===`$`||n===`$!`||n===`$?`||n===`$~`||n===`&`){if(t===0)return e;t--}else n!==`/$`&&n!==`/&`||t++}e=e.previousSibling}return null}function ff(e,t,n){switch(t=Bd(n),e){case`html`:if(e=t.documentElement,!e)throw Error(i(452));return e;case`head`:if(e=t.head,!e)throw Error(i(453));return e;case`body`:if(e=t.body,!e)throw Error(i(454));return e;default:throw Error(i(451))}}function pf(e){for(var t=e.attributes;t.length;)e.removeAttributeNode(t[0]);wt(e)}var mf=new Map,hf=new Set;function gf(e){return typeof e.getRootNode==`function`?e.getRootNode():e.nodeType===9?e:e.ownerDocument}var _f=E.d;E.d={f:vf,r:yf,D:Sf,C:Cf,L:wf,m:Tf,X:Df,S:Ef,M:Of};function vf(){var e=_f.f(),t=bu();return e||t}function yf(e){var t=Et(e);t!==null&&t.tag===5&&t.type===`form`?js(t):_f.r(e)}var bf=typeof document>`u`?null:document;function xf(e,t,n){var r=bf;if(r&&typeof t==`string`&&t){var i=qt(t);i=`link[rel="`+e+`"][href="`+i+`"]`,typeof n==`string`&&(i+=`[crossorigin="`+n+`"]`),hf.has(i)||(hf.add(i),e={rel:e,crossOrigin:n,href:t},r.querySelector(i)===null&&(t=r.createElement(`link`),Pd(t,`link`,e),k(t),r.head.appendChild(t)))}}function Sf(e){_f.D(e),xf(`dns-prefetch`,e,null)}function Cf(e,t){_f.C(e,t),xf(`preconnect`,e,t)}function wf(e,t,n){_f.L(e,t,n);var r=bf;if(r&&e&&t){var i=`link[rel="preload"][as="`+qt(t)+`"]`;t===`image`&&n&&n.imageSrcSet?(i+=`[imagesrcset="`+qt(n.imageSrcSet)+`"]`,typeof n.imageSizes==`string`&&(i+=`[imagesizes="`+qt(n.imageSizes)+`"]`)):i+=`[href="`+qt(e)+`"]`;var a=i;switch(t){case`style`:a=Af(e);break;case`script`:a=Pf(e)}mf.has(a)||(e=h({rel:`preload`,href:t===`image`&&n&&n.imageSrcSet?void 0:e,as:t},n),mf.set(a,e),r.querySelector(i)!==null||t===`style`&&r.querySelector(jf(a))||t===`script`&&r.querySelector(Ff(a))||(t=r.createElement(`link`),Pd(t,`link`,e),k(t),r.head.appendChild(t)))}}function Tf(e,t){_f.m(e,t);var n=bf;if(n&&e){var r=t&&typeof t.as==`string`?t.as:`script`,i=`link[rel="modulepreload"][as="`+qt(r)+`"][href="`+qt(e)+`"]`,a=i;switch(r){case`audioworklet`:case`paintworklet`:case`serviceworker`:case`sharedworker`:case`worker`:case`script`:a=Pf(e)}if(!mf.has(a)&&(e=h({rel:`modulepreload`,href:e},t),mf.set(a,e),n.querySelector(i)===null)){switch(r){case`audioworklet`:case`paintworklet`:case`serviceworker`:case`sharedworker`:case`worker`:case`script`:if(n.querySelector(Ff(a)))return}r=n.createElement(`link`),Pd(r,`link`,e),k(r),n.head.appendChild(r)}}}function Ef(e,t,n){_f.S(e,t,n);var r=bf;if(r&&e){var i=Ot(r).hoistableStyles,a=Af(e);t||=`default`;var o=i.get(a);if(!o){var s={loading:0,preload:null};if(o=r.querySelector(jf(a)))s.loading=5;else{e=h({rel:`stylesheet`,href:e,"data-precedence":t},n),(n=mf.get(a))&&Rf(e,n);var c=o=r.createElement(`link`);k(c),Pd(c,`link`,e),c._p=new Promise(function(e,t){c.onload=e,c.onerror=t}),c.addEventListener(`load`,function(){s.loading|=1}),c.addEventListener(`error`,function(){s.loading|=2}),s.loading|=4,Lf(o,t,r)}o={type:`stylesheet`,instance:o,count:1,state:s},i.set(a,o)}}}function Df(e,t){_f.X(e,t);var n=bf;if(n&&e){var r=Ot(n).hoistableScripts,i=Pf(e),a=r.get(i);a||(a=n.querySelector(Ff(i)),a||(e=h({src:e,async:!0},t),(t=mf.get(i))&&zf(e,t),a=n.createElement(`script`),k(a),Pd(a,`link`,e),n.head.appendChild(a)),a={type:`script`,instance:a,count:1,state:null},r.set(i,a))}}function Of(e,t){_f.M(e,t);var n=bf;if(n&&e){var r=Ot(n).hoistableScripts,i=Pf(e),a=r.get(i);a||(a=n.querySelector(Ff(i)),a||(e=h({src:e,async:!0,type:`module`},t),(t=mf.get(i))&&zf(e,t),a=n.createElement(`script`),k(a),Pd(a,`link`,e),n.head.appendChild(a)),a={type:`script`,instance:a,count:1,state:null},r.set(i,a))}}function kf(e,t,n,r){var a=(a=_e.current)?gf(a):null;if(!a)throw Error(i(446));switch(e){case`meta`:case`title`:return null;case`style`:return typeof n.precedence==`string`&&typeof n.href==`string`?(t=Af(n.href),n=Ot(a).hoistableStyles,r=n.get(t),r||(r={type:`style`,instance:null,count:0,state:null},n.set(t,r)),r):{type:`void`,instance:null,count:0,state:null};case`link`:if(n.rel===`stylesheet`&&typeof n.href==`string`&&typeof n.precedence==`string`){e=Af(n.href);var o=Ot(a).hoistableStyles,s=o.get(e);if(s||(a=a.ownerDocument||a,s={type:`stylesheet`,instance:null,count:0,state:{loading:0,preload:null}},o.set(e,s),(o=a.querySelector(jf(e)))&&!o._p&&(s.instance=o,s.state.loading=5),mf.has(e)||(n={rel:`preload`,as:`style`,href:n.href,crossOrigin:n.crossOrigin,integrity:n.integrity,media:n.media,hrefLang:n.hrefLang,referrerPolicy:n.referrerPolicy},mf.set(e,n),o||Nf(a,e,n,s.state))),t&&r===null)throw Error(i(528,``));return s}if(t&&r!==null)throw Error(i(529,``));return null;case`script`:return t=n.async,n=n.src,typeof n==`string`&&t&&typeof t!=`function`&&typeof t!=`symbol`?(t=Pf(n),n=Ot(a).hoistableScripts,r=n.get(t),r||(r={type:`script`,instance:null,count:0,state:null},n.set(t,r)),r):{type:`void`,instance:null,count:0,state:null};default:throw Error(i(444,e))}}function Af(e){return`href="`+qt(e)+`"`}function jf(e){return`link[rel="stylesheet"][`+e+`]`}function Mf(e){return h({},e,{"data-precedence":e.precedence,precedence:null})}function Nf(e,t,n,r){e.querySelector(`link[rel="preload"][as="style"][`+t+`]`)?r.loading=1:(t=e.createElement(`link`),r.preload=t,t.addEventListener(`load`,function(){return r.loading|=1}),t.addEventListener(`error`,function(){return r.loading|=2}),Pd(t,`link`,n),k(t),e.head.appendChild(t))}function Pf(e){return`[src="`+qt(e)+`"]`}function Ff(e){return`script[async]`+e}function If(e,t,n){if(t.count++,t.instance===null)switch(t.type){case`style`:var r=e.querySelector(`style[data-href~="`+qt(n.href)+`"]`);if(r)return t.instance=r,k(r),r;var a=h({},n,{"data-href":n.href,"data-precedence":n.precedence,href:null,precedence:null});return r=(e.ownerDocument||e).createElement(`style`),k(r),Pd(r,`style`,a),Lf(r,n.precedence,e),t.instance=r;case`stylesheet`:a=Af(n.href);var o=e.querySelector(jf(a));if(o)return t.state.loading|=4,t.instance=o,k(o),o;r=Mf(n),(a=mf.get(a))&&Rf(r,a),o=(e.ownerDocument||e).createElement(`link`),k(o);var s=o;return s._p=new Promise(function(e,t){s.onload=e,s.onerror=t}),Pd(o,`link`,r),t.state.loading|=4,Lf(o,n.precedence,e),t.instance=o;case`script`:return o=Pf(n.src),(a=e.querySelector(Ff(o)))?(t.instance=a,k(a),a):(r=n,(a=mf.get(o))&&(r=h({},n),zf(r,a)),e=e.ownerDocument||e,a=e.createElement(`script`),k(a),Pd(a,`link`,r),e.head.appendChild(a),t.instance=a);case`void`:return null;default:throw Error(i(443,t.type))}else t.type===`stylesheet`&&!(t.state.loading&4)&&(r=t.instance,t.state.loading|=4,Lf(r,n.precedence,e));return t.instance}function Lf(e,t,n){for(var r=n.querySelectorAll(`link[rel="stylesheet"][data-precedence],style[data-precedence]`),i=r.length?r[r.length-1]:null,a=i,o=0;o<r.length;o++){var s=r[o];if(s.dataset.precedence===t)a=s;else if(a!==i)break}a?a.parentNode.insertBefore(e,a.nextSibling):(t=n.nodeType===9?n.head:n,t.insertBefore(e,t.firstChild))}function Rf(e,t){e.crossOrigin??=t.crossOrigin,e.referrerPolicy??=t.referrerPolicy,e.title??=t.title}function zf(e,t){e.crossOrigin??=t.crossOrigin,e.referrerPolicy??=t.referrerPolicy,e.integrity??=t.integrity}var Bf=null;function Vf(e,t,n){if(Bf===null){var r=new Map,i=Bf=new Map;i.set(n,r)}else i=Bf,r=i.get(n),r||(r=new Map,i.set(n,r));if(r.has(e))return r;for(r.set(e,null),n=n.getElementsByTagName(e),i=0;i<n.length;i++){var a=n[i];if(!(a[Ct]||a[gt]||e===`link`&&a.getAttribute(`rel`)===`stylesheet`)&&a.namespaceURI!==`http://www.w3.org/2000/svg`){var o=a.getAttribute(t)||``;o=e+o;var s=r.get(o);s?s.push(a):r.set(o,[a])}}return r}function Hf(e,t,n){e=e.ownerDocument||e,e.head.insertBefore(n,t===`title`?e.querySelector(`head > title`):null)}function Uf(e,t,n){if(n===1||t.itemProp!=null)return!1;switch(e){case`meta`:case`title`:return!0;case`style`:if(typeof t.precedence!=`string`||typeof t.href!=`string`||t.href===``)break;return!0;case`link`:if(typeof t.rel!=`string`||typeof t.href!=`string`||t.href===``||t.onLoad||t.onError)break;switch(t.rel){case`stylesheet`:return e=t.disabled,typeof t.precedence==`string`&&e==null;default:return!0}case`script`:if(t.async&&typeof t.async!=`function`&&typeof t.async!=`symbol`&&!t.onLoad&&!t.onError&&t.src&&typeof t.src==`string`)return!0}return!1}function Wf(e){return!(e.type===`stylesheet`&&!(e.state.loading&3))}function Gf(e,t,n,r){if(n.type===`stylesheet`&&(typeof r.media!=`string`||!1!==matchMedia(r.media).matches)&&!(n.state.loading&4)){if(n.instance===null){var i=Af(r.href),a=t.querySelector(jf(i));if(a){t=a._p,typeof t==`object`&&t&&typeof t.then==`function`&&(e.count++,e=Jf.bind(e),t.then(e,e)),n.state.loading|=4,n.instance=a,k(a);return}a=t.ownerDocument||t,r=Mf(r),(i=mf.get(i))&&Rf(r,i),a=a.createElement(`link`),k(a);var o=a;o._p=new Promise(function(e,t){o.onload=e,o.onerror=t}),Pd(a,`link`,r),n.instance=a}e.stylesheets===null&&(e.stylesheets=new Map),e.stylesheets.set(n,t),(t=n.state.preload)&&!(n.state.loading&3)&&(e.count++,n=Jf.bind(e),t.addEventListener(`load`,n),t.addEventListener(`error`,n))}}var Kf=0;function qf(e,t){return e.stylesheets&&e.count===0&&Xf(e,e.stylesheets),0<e.count||0<e.imgCount?function(n){var r=setTimeout(function(){if(e.stylesheets&&Xf(e,e.stylesheets),e.unsuspend){var t=e.unsuspend;e.unsuspend=null,t()}},6e4+t);0<e.imgBytes&&Kf===0&&(Kf=62500*Ld());var i=setTimeout(function(){if(e.waitingForImages=!1,e.count===0&&(e.stylesheets&&Xf(e,e.stylesheets),e.unsuspend)){var t=e.unsuspend;e.unsuspend=null,t()}},(e.imgBytes>Kf?50:800)+t);return e.unsuspend=n,function(){e.unsuspend=null,clearTimeout(r),clearTimeout(i)}}:null}function Jf(){if(this.count--,this.count===0&&(this.imgCount===0||!this.waitingForImages)){if(this.stylesheets)Xf(this,this.stylesheets);else if(this.unsuspend){var e=this.unsuspend;this.unsuspend=null,e()}}}var Yf=null;function Xf(e,t){e.stylesheets=null,e.unsuspend!==null&&(e.count++,Yf=new Map,t.forEach(Zf,e),Yf=null,Jf.call(e))}function Zf(e,t){if(!(t.state.loading&4)){var n=Yf.get(e);if(n)var r=n.get(null);else{n=new Map,Yf.set(e,n);for(var i=e.querySelectorAll(`link[data-precedence],style[data-precedence]`),a=0;a<i.length;a++){var o=i[a];(o.nodeName===`LINK`||o.getAttribute(`media`)!==`not all`)&&(n.set(o.dataset.precedence,o),r=o)}r&&n.set(null,r)}i=t.instance,o=i.getAttribute(`data-precedence`),a=n.get(o)||r,a===r&&n.set(null,i),n.set(o,i),this.count++,r=Jf.bind(this),i.addEventListener(`load`,r),i.addEventListener(`error`,r),a?a.parentNode.insertBefore(i,a.nextSibling):(e=e.nodeType===9?e.head:e,e.insertBefore(i,e.firstChild)),t.state.loading|=4}}var Qf={$$typeof:S,Provider:null,Consumer:null,_currentValue:de,_currentValue2:de,_threadCount:0};function $f(e,t,n,r,i,a,o,s,c){this.tag=1,this.containerInfo=e,this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.callbackNode=this.next=this.pendingContext=this.context=this.cancelPendingCommit=null,this.callbackPriority=0,this.expirationTimes=at(-1),this.entangledLanes=this.shellSuspendCounter=this.errorRecoveryDisabledLanes=this.expiredLanes=this.warmLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=at(0),this.hiddenUpdates=at(null),this.identifierPrefix=r,this.onUncaughtError=i,this.onCaughtError=a,this.onRecoverableError=o,this.pooledCache=null,this.pooledCacheLanes=0,this.formState=c,this.incompleteTransitions=new Map}function ep(e,t,n,r,i,a,o,s,c,l,u,d){return e=new $f(e,t,n,o,c,l,u,d,s),t=1,!0===a&&(t|=24),a=_i(3,null,null,t),e.current=a,a.stateNode=e,t=ha(),t.refCount++,e.pooledCache=t,t.refCount++,a.memoizedState={element:r,isDehydrated:n,cache:t},Ja(a),e}function tp(e){return e?(e=hi,e):hi}function np(e,t,n,r,i,a){i=tp(i),r.context===null?r.context=i:r.pendingContext=i,r=Xa(t),r.payload={element:n},a=a===void 0?null:a,a!==null&&(r.callback=a),n=Za(e,r,t),n!==null&&(hu(n,e,t),Qa(n,e,t))}function rp(e,t){if(e=e.memoizedState,e!==null&&e.dehydrated!==null){var n=e.retryLane;e.retryLane=n!==0&&n<t?n:t}}function ip(e,t){rp(e,t),(e=e.alternate)&&rp(e,t)}function ap(e){if(e.tag===13||e.tag===31){var t=fi(e,67108864);t!==null&&hu(t,e,67108864),ip(e,67108864)}}function op(e){if(e.tag===13||e.tag===31){var t=pu();t=dt(t);var n=fi(e,t);n!==null&&hu(n,e,t),ip(e,t)}}var sp=!0;function cp(e,t,n,r){var i=T.T;T.T=null;var a=E.p;try{E.p=2,up(e,t,n,r)}finally{E.p=a,T.T=i}}function lp(e,t,n,r){var i=T.T;T.T=null;var a=E.p;try{E.p=8,up(e,t,n,r)}finally{E.p=a,T.T=i}}function up(e,t,n,r){if(sp){var i=dp(r);if(i===null)wd(e,t,r,fp,n),Cp(e,r);else if(Tp(i,e,t,n,r))r.stopPropagation();else if(Cp(e,r),t&4&&-1<Sp.indexOf(e)){for(;i!==null;){var a=Et(i);if(a!==null)switch(a.tag){case 3:if(a=a.stateNode,a.current.memoizedState.isDehydrated){var o=et(a.pendingLanes);if(o!==0){var s=a;for(s.pendingLanes|=2,s.entangledLanes|=2;o;){var c=1<<31-qe(o);s.entanglements[1]|=c,o&=~c}rd(a),!(W&6)&&(nu=Fe()+500,id(0,!1))}}break;case 31:case 13:s=fi(a,2),s!==null&&hu(s,a,2),bu(),ip(a,2)}if(a=dp(r),a===null&&wd(e,t,r,fp,n),a===i)break;i=a}i!==null&&r.stopPropagation()}else wd(e,t,r,null,n)}}function dp(e){return e=dn(e),pp(e)}var fp=null;function pp(e){if(fp=null,e=Tt(e),e!==null){var t=o(e);if(t===null)e=null;else{var n=t.tag;if(n===13){if(e=s(t),e!==null)return e;e=null}else if(n===31){if(e=c(t),e!==null)return e;e=null}else if(n===3){if(t.stateNode.current.memoizedState.isDehydrated)return t.tag===3?t.stateNode.containerInfo:null;e=null}else t!==e&&(e=null)}}return fp=e,null}function mp(e){switch(e){case`beforetoggle`:case`cancel`:case`click`:case`close`:case`contextmenu`:case`copy`:case`cut`:case`auxclick`:case`dblclick`:case`dragend`:case`dragstart`:case`drop`:case`focusin`:case`focusout`:case`input`:case`invalid`:case`keydown`:case`keypress`:case`keyup`:case`mousedown`:case`mouseup`:case`paste`:case`pause`:case`play`:case`pointercancel`:case`pointerdown`:case`pointerup`:case`ratechange`:case`reset`:case`resize`:case`seeked`:case`submit`:case`toggle`:case`touchcancel`:case`touchend`:case`touchstart`:case`volumechange`:case`change`:case`selectionchange`:case`textInput`:case`compositionstart`:case`compositionend`:case`compositionupdate`:case`beforeblur`:case`afterblur`:case`beforeinput`:case`blur`:case`fullscreenchange`:case`focus`:case`hashchange`:case`popstate`:case`select`:case`selectstart`:return 2;case`drag`:case`dragenter`:case`dragexit`:case`dragleave`:case`dragover`:case`mousemove`:case`mouseout`:case`mouseover`:case`pointermove`:case`pointerout`:case`pointerover`:case`scroll`:case`touchmove`:case`wheel`:case`mouseenter`:case`mouseleave`:case`pointerenter`:case`pointerleave`:return 8;case`message`:switch(Ie()){case Le:return 2;case Re:return 8;case ze:case Be:return 32;case Ve:return 268435456;default:return 32}default:return 32}}var hp=!1,gp=null,_p=null,vp=null,yp=new Map,bp=new Map,xp=[],Sp=`mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset`.split(` `);function Cp(e,t){switch(e){case`focusin`:case`focusout`:gp=null;break;case`dragenter`:case`dragleave`:_p=null;break;case`mouseover`:case`mouseout`:vp=null;break;case`pointerover`:case`pointerout`:yp.delete(t.pointerId);break;case`gotpointercapture`:case`lostpointercapture`:bp.delete(t.pointerId)}}function wp(e,t,n,r,i,a){return e===null||e.nativeEvent!==a?(e={blockedOn:t,domEventName:n,eventSystemFlags:r,nativeEvent:a,targetContainers:[i]},t!==null&&(t=Et(t),t!==null&&ap(t)),e):(e.eventSystemFlags|=r,t=e.targetContainers,i!==null&&t.indexOf(i)===-1&&t.push(i),e)}function Tp(e,t,n,r,i){switch(t){case`focusin`:return gp=wp(gp,e,t,n,r,i),!0;case`dragenter`:return _p=wp(_p,e,t,n,r,i),!0;case`mouseover`:return vp=wp(vp,e,t,n,r,i),!0;case`pointerover`:var a=i.pointerId;return yp.set(a,wp(yp.get(a)||null,e,t,n,r,i)),!0;case`gotpointercapture`:return a=i.pointerId,bp.set(a,wp(bp.get(a)||null,e,t,n,r,i)),!0}return!1}function Ep(e){var t=Tt(e.target);if(t!==null){var n=o(t);if(n!==null){if(t=n.tag,t===13){if(t=s(n),t!==null){e.blockedOn=t,mt(e.priority,function(){op(n)});return}}else if(t===31){if(t=c(n),t!==null){e.blockedOn=t,mt(e.priority,function(){op(n)});return}}else if(t===3&&n.stateNode.current.memoizedState.isDehydrated){e.blockedOn=n.tag===3?n.stateNode.containerInfo:null;return}}}e.blockedOn=null}function Dp(e){if(e.blockedOn!==null)return!1;for(var t=e.targetContainers;0<t.length;){var n=dp(e.nativeEvent);if(n===null){n=e.nativeEvent;var r=new n.constructor(n.type,n);un=r,n.target.dispatchEvent(r),un=null}else return t=Et(n),t!==null&&ap(t),e.blockedOn=n,!1;t.shift()}return!0}function Op(e,t,n){Dp(e)&&n.delete(t)}function kp(){hp=!1,gp!==null&&Dp(gp)&&(gp=null),_p!==null&&Dp(_p)&&(_p=null),vp!==null&&Dp(vp)&&(vp=null),yp.forEach(Op),bp.forEach(Op)}function Ap(e,n){e.blockedOn===n&&(e.blockedOn=null,hp||(hp=!0,t.unstable_scheduleCallback(t.unstable_NormalPriority,kp)))}var jp=null;function Mp(e){jp!==e&&(jp=e,t.unstable_scheduleCallback(t.unstable_NormalPriority,function(){jp===e&&(jp=null);for(var t=0;t<e.length;t+=3){var n=e[t],r=e[t+1],i=e[t+2];if(typeof r!=`function`){if(pp(r||n)===null)continue;break}var a=Et(n);a!==null&&(e.splice(t,3),t-=3,ks(a,{pending:!0,data:i,method:n.method,action:r},r,i))}}))}function Np(e){function t(t){return Ap(t,e)}gp!==null&&Ap(gp,e),_p!==null&&Ap(_p,e),vp!==null&&Ap(vp,e),yp.forEach(t),bp.forEach(t);for(var n=0;n<xp.length;n++){var r=xp[n];r.blockedOn===e&&(r.blockedOn=null)}for(;0<xp.length&&(n=xp[0],n.blockedOn===null);)Ep(n),n.blockedOn===null&&xp.shift();if(n=(e.ownerDocument||e).$$reactFormReplay,n!=null)for(r=0;r<n.length;r+=3){var i=n[r],a=n[r+1],o=i[_t]||null;if(typeof a==`function`)o||Mp(n);else if(o){var s=null;if(a&&a.hasAttribute(`formAction`)){if(i=a,o=a[_t]||null)s=o.formAction;else if(pp(i)!==null)continue}else s=o.action;typeof s==`function`?n[r+1]=s:(n.splice(r,3),r-=3),Mp(n)}}}function Pp(){function e(e){e.canIntercept&&e.info===`react-transition`&&e.intercept({handler:function(){return new Promise(function(e){return i=e})},focusReset:`manual`,scroll:`manual`})}function t(){i!==null&&(i(),i=null),r||setTimeout(n,20)}function n(){if(!r&&!navigation.transition){var e=navigation.currentEntry;e&&e.url!=null&&navigation.navigate(e.url,{state:e.getState(),info:`react-transition`,history:`replace`})}}if(typeof navigation==`object`){var r=!1,i=null;return navigation.addEventListener(`navigate`,e),navigation.addEventListener(`navigatesuccess`,t),navigation.addEventListener(`navigateerror`,t),setTimeout(n,100),function(){r=!0,navigation.removeEventListener(`navigate`,e),navigation.removeEventListener(`navigatesuccess`,t),navigation.removeEventListener(`navigateerror`,t),i!==null&&(i(),i=null)}}}function Fp(e){this._internalRoot=e}Ip.prototype.render=Fp.prototype.render=function(e){var t=this._internalRoot;if(t===null)throw Error(i(409));var n=t.current;np(n,pu(),e,t,null,null)},Ip.prototype.unmount=Fp.prototype.unmount=function(){var e=this._internalRoot;if(e!==null){this._internalRoot=null;var t=e.containerInfo;np(e.current,2,null,e,null,null),bu(),t[vt]=null}};function Ip(e){this._internalRoot=e}Ip.prototype.unstable_scheduleHydration=function(e){if(e){var t=pt();e={blockedOn:null,target:e,priority:t};for(var n=0;n<xp.length&&t!==0&&t<xp[n].priority;n++);xp.splice(n,0,e),n===0&&Ep(e)}};var Lp=n.version;if(Lp!==`19.2.6`)throw Error(i(527,Lp,`19.2.6`));E.findDOMNode=function(e){var t=e._reactInternals;if(t===void 0)throw typeof e.render==`function`?Error(i(188)):(e=Object.keys(e).join(`,`),Error(i(268,e)));return e=d(t),e=e===null?null:p(e),e=e===null?null:e.stateNode,e};var Rp={bundleType:0,version:`19.2.6`,rendererPackageName:`react-dom`,currentDispatcherRef:T,reconcilerVersion:`19.2.6`};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__<`u`){var zp=__REACT_DEVTOOLS_GLOBAL_HOOK__;if(!zp.isDisabled&&zp.supportsFiber)try{We=zp.inject(Rp),Ge=zp}catch{}}e.createRoot=function(e,t){if(!a(e))throw Error(i(299));var n=!1,r=``,o=Qs,s=$s,c=ec;return t!=null&&(!0===t.unstable_strictMode&&(n=!0),t.identifierPrefix!==void 0&&(r=t.identifierPrefix),t.onUncaughtError!==void 0&&(o=t.onUncaughtError),t.onCaughtError!==void 0&&(s=t.onCaughtError),t.onRecoverableError!==void 0&&(c=t.onRecoverableError)),t=ep(e,1,!1,null,null,n,r,null,o,s,c,Pp),e[vt]=t.current,Sd(e),new Fp(t)}})),g=o(((e,t)=>{function n(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>`u`||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!=`function`))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(n)}catch(e){console.error(e)}}n(),t.exports=h()})),_=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),v=o(((e,t)=>{t.exports=_()})),y=g(),b=c(u(),1),x=v(),ee=()=>(0,x.jsx)(`style`,{dangerouslySetInnerHTML:{__html:`
  ...
  `}}),S=()=>{let e=(0,b.useRef)(null),t=(0,b.useRef)(null),n=(0,b.useRef)({x:0,y:0}),r=(0,b.useRef)({x:0,y:0});return(0,b.useEffect)(()=>{let i=t=>{n.current.x=t.clientX,n.current.y=t.clientY,e.current&&(e.current.style.transform=`translate3d(${t.clientX}px, ${t.clientY}px, 0) translate(-50%, -50%)`)},a=()=>{e.current&&(e.current.style.transform=`translate3d(${n.current.x}px, ${n.current.y}px, 0) translate(-50%, -50%) scale(1.5)`)},o=()=>{e.current&&(e.current.style.transform=`translate3d(${n.current.x}px, ${n.current.y}px, 0) translate(-50%, -50%) scale(1)`)};window.addEventListener(`mousemove`,i),window.addEventListener(`mousedown`,a),window.addEventListener(`mouseup`,o);let s,c=()=>{let e=.14;r.current.x+=(n.current.x-r.current.x)*e,r.current.y+=(n.current.y-r.current.y)*e,t.current&&(t.current.style.transform=`translate3d(${r.current.x}px, ${r.current.y}px, 0) translate(-50%, -50%)`),s=requestAnimationFrame(c)};return c(),()=>{window.removeEventListener(`mousemove`,i),window.removeEventListener(`mousedown`,a),window.removeEventListener(`mouseup`,o),cancelAnimationFrame(s)}},[]),(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(`div`,{ref:e,id:`cursor-dot`,style:{position:`fixed`,top:0,left:0,width:`10px`,height:`10px`,backgroundColor:`var(--cyan)`,borderRadius:`50%`,pointerEvents:`none`,zIndex:9999,boxShadow:`0 0 16px var(--cyan), 0 0 40px rgba(34,211,238,0.4)`,transition:`transform 0.05s, background 0.3s`}}),(0,x.jsx)(`div`,{ref:t,id:`cursor-ring`,style:{position:`fixed`,top:0,left:0,width:`36px`,height:`36px`,border:`1.5px solid rgba(34,211,238,0.5)`,borderRadius:`50%`,pointerEvents:`none`,zIndex:9998,transition:`width 0.2s, height 0.2s, border-color 0.2s`}})]})},C=()=>(0,x.jsx)(`div`,{style:{position:`fixed`,top:0,left:0,width:`100vw`,height:`100vh`,pointerEvents:`none`,zIndex:-1,overflow:`hidden`},children:(0,b.useMemo)(()=>{let e=[`#0ea5e9`,`#a855f7`,`#10b981`,`#f59e0b`,`#ec4899`,`#22d3ee`],t=[];for(let n=0;n<40;n++){let r=e[Math.floor(Math.random()*e.length)],i=Math.random()*3+1,a=Math.random()*100,o=Math.random()*20+12,s=Math.random()*15,c=(Math.random()-.5)*200;t.push({id:n,color:r,size:i,left:a,duration:o,delay:s,dx:c})}return t},[]).map(e=>(0,x.jsx)(`div`,{style:{position:`absolute`,bottom:`-10px`,left:`${e.left}vw`,width:`${e.size}px`,height:`${e.size}px`,backgroundColor:e.color,borderRadius:`50%`,boxShadow:`0 0 ${e.size*2}px ${e.color}`,opacity:.6,"--dx":`${e.dx}px`,animation:`particle-drift ${e.duration}s linear ${e.delay}s infinite`}},e.id))}),te=({currentPage:e})=>{let[t,n]=(0,b.useState)({x:0,y:0}),[r,i]=(0,b.useState)(!1),a=(0,b.useRef)({x:0,y:0}),o=(0,b.useRef)({x:0,y:0}),s=(0,b.useRef)(),c=e===`landing`,l=c?.12:.08,u=c?`40vw`:`30vw`,d=c?`8%`:`4%`,f=c?`15%`:`8%`;return(0,b.useEffect)(()=>{let e=e=>{let t=e.clientX/window.innerWidth-.5,n=e.clientY/window.innerHeight-.5;a.current={x:t*-25,y:n*-25}},t=()=>{i(!0),setTimeout(()=>i(!1),800)};window.addEventListener(`mousemove`,e),window.addEventListener(`click`,t);let n=()=>{o.current.x+=(a.current.x-o.current.x)*.08,o.current.y+=(a.current.y-o.current.y)*.08;let e=document.getElementById(`bg-robot-companion`);e&&(e.style.transform=`translate3d(${o.current.x}px, ${o.current.y}px, 0) rotate(${o.current.x*.05}deg)`),s.current=requestAnimationFrame(n)};return s.current=requestAnimationFrame(n),()=>{window.removeEventListener(`mousemove`,e),window.removeEventListener(`click`,t),cancelAnimationFrame(s.current)}},[]),(0,x.jsxs)(`div`,{style:{position:`fixed`,top:0,left:0,right:0,bottom:0,pointerEvents:`none`,zIndex:-1,overflow:`hidden`},children:[(0,x.jsx)(`div`,{style:{position:`absolute`,right:`calc(${d} + 10vw)`,bottom:`calc(${f} + 15vh)`,width:`40vw`,height:`40vw`,borderRadius:`50%`,background:r?`radial-gradient(circle, rgba(34,211,238,0.25) 0%, rgba(168,85,247,0.12) 50%, transparent 70%)`:`radial-gradient(circle, rgba(34,211,238,0.15) 0%, rgba(168,85,247,0.06) 50%, transparent 70%)`,filter:`blur(60px)`,transition:`all 0.8s cubic-bezier(0.16, 1, 0.3, 1)`,opacity:c?.7:.4,animation:`pulse-glow 6s infinite ease-in-out`}}),(0,x.jsx)(`div`,{style:{position:`absolute`,right:d,bottom:f,width:u,height:`calc(${u} * 1.2)`,opacity:c?.15:.08,backgroundImage:`linear-gradient(rgba(34,211,238,0.1) 1px, transparent 1px), linear-gradient(90deg, rgba(34,211,238,0.1) 1px, transparent 1px)`,backgroundSize:`20px 20px`,maskImage:`radial-gradient(circle, black 40%, transparent 80%)`,WebkitMaskImage:`radial-gradient(circle, black 40%, transparent 80%)`,transition:`all 1s cubic-bezier(0.16, 1, 0.3, 1)`}}),(0,x.jsxs)(`div`,{id:`bg-robot-companion`,className:`float-c`,style:{position:`absolute`,right:d,bottom:f,width:u,height:`calc(${u} * 1.2)`,backgroundImage:`url(/robot.png)`,backgroundSize:`contain`,backgroundPosition:`center bottom`,backgroundRepeat:`no-repeat`,opacity:l,filter:r?`drop-shadow(0 0 50px rgba(34,211,238,0.5)) brightness(1.2)`:`drop-shadow(0 0 30px rgba(34,211,238,0.25))`,transition:`width 1s cubic-bezier(0.16, 1, 0.3, 1), height 1s cubic-bezier(0.16, 1, 0.3, 1), right 1s cubic-bezier(0.16, 1, 0.3, 1), bottom 1s cubic-bezier(0.16, 1, 0.3, 1), opacity 1s ease, filter 0.3s ease`,willChange:`transform`},children:[(0,x.jsx)(`div`,{style:{position:`absolute`,top:0,left:0,right:0,bottom:0,background:`linear-gradient(to bottom, transparent 50%, rgba(34,211,238,0.05) 50%)`,backgroundSize:`100% 4px`,borderRadius:`20px`,opacity:.5}}),(0,x.jsx)(`div`,{style:{position:`absolute`,top:`30%`,left:`10%`,right:`10%`,bottom:`30%`,border:`1px dashed rgba(34,211,238,0.15)`,borderRadius:`50%`,transform:`rotateX(75deg) rotateY(15deg)`,animation:`ring-spin 25s linear infinite`,pointerEvents:`none`,boxShadow:`0 0 15px rgba(34,211,238,0.05)`}})]})]})},ne=[{id:`planner`,name:`Planner AI`,role:`Expert productivity coach`,color:`#0ea5e9`,gradient:`#0ea5e9, #6366f1`,floatClass:`float-a`,capabilities:[`Timetable Creation`,`Goal Breakdown`,`Smart Scheduling`,`Habit Tracking`,`Priority Matrix`],suggestions:[`Create my weekly schedule`,`Help me break down my goals`,`Build a morning routine`],description:`Your elite AI productivity coach for scheduling, goal breakdown, timetable creation, habit tracking, and priority systems.`,system:`# SKILL.md — Planner Agent
...
`},{id:`oracle`,name:`Oracle AI`,role:`Futuristic trend analyst`,color:`#a855f7`,gradient:`#a855f7, #ec4899`,floatClass:`float-b`,capabilities:[`Future Trend Analysis`,`Career Roadmap`,`Skill Prediction`,`Market Insights`,`Industry Foresight`],suggestions:[`What skills will be in demand in 2027?`,`Analyze my career path`,`Predict AI industry trends`],description:`Your futuristic trend analyst for career paths, skill prediction, market intelligence, and industry foresight.`,system:`# SKILL.md — Future Prediction Agent

---
name: prediction-agent
agent: PredictionAgent
version: 1.0.0
trigger: future, predict, career, trends, market, forecast, skills, roadmap, job, salary, industry, habit, outcome, opportunity, growth
---

## Purpose

The Future Prediction Agent analyzes trends, provides career forecasts, predicts skill demand, generates career roadmaps, and helps users make informed decisions about their future — based on current data patterns, not guarantees.
...
Activate this agent when the user mentions:
- Career path decisions or switches
- Job market trends or salary expectations
- Which skills to learn for the future
- Technology or industry trend analysis
- Predicting outcomes of current habits or choices
- Business or market forecasting
- Future of a specific field (AI, medicine, law, engineering, etc.)
- What jobs will exist or disappear in the next 5–10 years

---

## Agent Persona

You are **PredictionAgent** — an AI trend analyst and future insights advisor inside AgentVerse AI.

You think like a combination of a career counselor, a market analyst, and a futurist researcher. You are data-informed, balanced, and empowering — never alarmist, never over-promising. You help users see possibilities and plan with clarity.

---

## Core Responsibilities

1. Analyze career trends and job market outlook by industry
2. Predict skill demand over the next 2–5 years
3. Generate personalized career roadmaps based on user's current profile
4. Forecast technology and market trends
5. Identify emerging opportunities in growing sectors
6. Predict likely outcomes based on the user's current habits and choices
7. Compare career paths with pros, cons, and earning potential
8. Advise on future-proof skills for any background
...
\`\`\`
RULE 1 — NEVER GUARANTEE
  NEVER say: "You will definitely earn X" or "This will 100% happen."
  ALWAYS say: "Trends suggest...", "Based on current data...", "Indicators show..."

RULE 2 — ALWAYS INCLUDE THE DISCLAIMER
  Every prediction response must end with the standard disclaimer.

RULE 3 — BALANCED OUTLOOK
  Never create unnecessary fear ("AI will take all jobs!")
  Never create false hope ("This field will make you rich!")
  Always present both opportunities AND risks.

RULE 4 — ASK BEFORE ADVISING
  Always collect user's background before generating a career roadmap.

RULE 5 — DATA-BASED LANGUAGE
  Ground all predictions in observable trends: hiring data, industry reports,
  tech adoption curves, skill demand patterns.
\`\`\`
...
\`\`\`
For Career Predictions:
- Current age / education level?
- Current field / skills?
- Interests or passions?
- Preferred work style? (remote / office / freelance / entrepreneurship)
- Target income range?
- Target country / city?
- Timeline: short-term (1yr) / medium (3yr) / long-term (5yr+)?

For Trend Analysis:
- Which industry or technology?
- Current awareness level of the topic?
...
\`\`\`
[ 🔮 PredictionAgent Activated ]

CAREER ANALYSIS: [User's Field or Interest]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

CURRENT MARKET SIGNAL
---------------------
[2–3 sentences describing the current state of this field based on trends]

OUTLOOK (2025–2030)
--------------------
Growth Direction:  [⬆️ Growing / ➡️ Stable / ⬇️ Declining]
Demand Level:      [High / Medium / Low]
Automation Risk:   [High / Medium / Low]
Avg Salary Range:  [Range in ₹ or $]
Top Hiring Cities: [City 1, City 2, City 3]

TOP OPPORTUNITIES
-----------------
1. [Role / Specialization] — [Why it's growing]
2. [Role / Specialization] — [Why it's growing]
3. [Role / Specialization] — [Why it's growing]
...
-----------------------------
• [Skill 1] — [Why this matters]
• [Skill 2] — [Why this matters]
• [Skill 3] — [Why this matters]

YOUR RECOMMENDED PATH
----------------------
[Personalized recommendation based on user's current profile]

⚠️ DISCLAIMER: These insights are AI-generated based on observable trends and are
for informational purposes only. Future outcomes may vary significantly based on
economic conditions, personal choices, and global events.
\`\`\`
...
TREND ANALYSIS: [Technology / Industry / Topic]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

WHERE IT STANDS NOW
-------------------
[Current state — adoption, market size, key players]

PREDICTED TRAJECTORY (Next 5 Years)
-------------------------------------
[Year 1]:  [What's likely to change]
[Year 2]:  [What's likely to change]
[Year 3-5]: [Longer-term outlook]

DRIVING FORCES
--------------
✅ [Factor pushing growth]
✅ [Factor pushing growth]
...
OPPORTUNITY WINDOW
------------------
[Best time to enter / act is: now / 1–2 years / wait and watch]

⚠️ DISCLAIMER: Trend analysis is based on observable patterns and is for
informational purposes only. All predictions carry inherent uncertainty.
\`\`\`

---

## Career Path Comparison Format

\`\`\`
CAREER COMPARISON
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

| Factor              | Path A: [Option]   | Path B: [Option]   |
|---------------------|--------------------|--------------------|
| Entry Barrier       | Low / Medium / High| Low / Medium / High|
| Avg Starting Salary | ₹X LPA / $Xk       | ₹X LPA / $Xk       |
| Growth Rate (5yr)   | XX%                | XX%                |
| Automation Risk     | Low / Med / High   | Low / Med / High   |
| Remote Work Possible| Yes / No / Partial | Yes / No / Partial |
| Skill Ramp-Up Time  | X months           | X months           |
| Job Satisfaction    | ⭐⭐⭐⭐            | ⭐⭐⭐              |

VERDICT: [Balanced recommendation based on user's profile]
\`\`\`

---

## Skill Demand Forecast (2025–2030)

\`\`\`
HIGH DEMAND SKILLS (Will grow significantly):
┌─────────────────────────────────────────────┐
...
│ Product Management                          │
│ UX / UI Design                              │
│ Prompt Engineering / AI Operations          │
│ Electric Vehicle Technology                 │
│ Renewable Energy Engineering                │
└─────────────────────────────────────────────┘

STABLE SKILLS (Will remain relevant):
┌─────────────────────────────────────────────┐
│ Healthcare / Medicine                       │
│ Civil Engineering                           │
│ Teaching / Coaching                         │
│ Skilled Trades (Electrician, Plumber)       │
│ Accounting (with AI tool proficiency)       │
└─────────────────────────────────────────────┘

DECLINING DEMAND (Automation risk):
┌─────────────────────────────────────────────┐
│ Basic Data Entry                            │
│ Routine Customer Support                    │
│ Manual Bookkeeping (without software skill) │
│ Basic Graphic Design (without creativity)   │
└─────────────────────────────────────────────┘
\`\`\`

---

## Habit Outcome Prediction

When a user shares a habit or daily choice, analyze likely 1yr / 5yr / 10yr outcomes:

\`\`\`
HABIT ANALYSIS
--------------
Input Habit: [User's stated habit]

IF CONTINUED:
1 Year  → [Likely outcome — health, skill, financial, relationship]
3 Years → [Compound effect outcome]
5 Years → [Long-term accumulated result]

POSITIVE SCENARIO (if habit is optimized):
[Best case if user improves the habit]

RISK SCENARIO (if habit is unchecked):
[Worst case if habit continues negatively]

RECOMMENDATION:
[One concrete action to improve the habit trajectory]
\`\`\`

---

## Industry Outlook Snapshots

| Industry              | 5-Year Outlook   | Key Driver                    | Risk             |
|-----------------------|------------------|-------------------------------|------------------|
| AI / Tech             | ⬆️ Very High     | Automation + Digital adoption | Regulation       |
| Healthcare            | ⬆️ High          | Aging population + AI tools   | Policy changes   |
| Renewable Energy      | ⬆️ High          | Climate policy + EVs          | Capex required   |
| Traditional Banking   | ➡️ Stable        | Fintech disruption ongoing    | Digital shift    |
| E-commerce            | ⬆️ High          | India's internet growth       | Margin pressure  |
| Manufacturing         | ➡️ Stable        | PLI schemes + automation      | Labor shifts     |
| Education (Online)    | ⬆️ High          | EdTech + skill demand         | Quality concerns |
| Real Estate           | ➡️ Mixed         | Urbanization + interest rates | Economic cycles  |
| Media / Entertainment | ➡️ Shifting      | OTT + creator economy         | Ad revenue drops |
| Traditional Retail    | ⬇️ Declining     | E-commerce disruption         | Margin squeeze   |
...
| Partner Agent    | Combined Use Case                                                |
|------------------|------------------------------------------------------------------|
| PlannerAgent     | Converts career roadmap into a daily/weekly action schedule      |
| LearningAgent    | Builds a learning curriculum for the predicted in-demand skills  |
| LawyerAgent      | Advises on legal/regulatory trends affecting a business sector   |

Activation example:
\`\`\`
User: "I want to transition from marketing to AI in 2 years. Help me plan."
→ Activate: PredictionAgent (trend + roadmap) + LearningAgent (skill path) + PlannerAgent (schedule)
\`\`\`
...
Your job is to analyze career trends, predict skill demand, generate career roadmaps,
and help users make informed decisions about their future.

ALWAYS collect user's background before giving career advice:
age, education, current skills, interests, target timeline.

Use confident but cautious language:
"Trends suggest...", "Based on current data...", "Indicators show..."

NEVER guarantee specific outcomes. Present both opportunities AND risks.
Show multiple career paths when relevant with pros/cons comparison.

For skill demand: rank by growth trajectory (high/stable/declining).
For habit predictions: show 1yr / 3yr / 5yr compound outcomes.

ALWAYS end with the disclaimer:
⚠️ These insights are AI-generated based on current trends and are for informational
purposes only. Future outcomes may vary significantly.
\`\`\`
...
> ⚠️ **PredictionAgent Disclaimer:** All trend analyses, career forecasts, and future predictions provided by this AI are based on observable current patterns and publicly available information. They are for informational and planning purposes only. Future outcomes depend on many unpredictable factors including economic shifts, personal choices, global events, and individual effort. These insights do NOT constitute financial, investment, or professional career advice. Always consult qualified professionals before making major life decisions.
...
|---------|------------|----------------------|
| 1.0.0   | 2025-01-01 | Initial release      |
`},{id:`medic`,name:`Medic AI`,role:`Health and wellness assistant`,color:`#10b981`,gradient:`#10b981, #06b6d4`,floatClass:`float-c`,capabilities:[`Wellness Guidance`,`Symptom Understanding`,`Diet Plans`,`Mental Health`,`Health Education`],suggestions:[`Tips for better sleep`,`Explain symptoms of stress`,`Create a balanced diet plan`],description:`Your compassionate health and wellness assistant for general health info, diet plans, mental health, and symptom awareness.`,system:`# SKILL.md — Medical Agent
...
|---------|------------|--------------------------------|
| 1.0.0   | 2025-01-01 | Initial release                |
`},{id:`lex`,name:`Lex AI`,role:`Legal information assistant`,color:`#f59e0b`,gradient:`#f59e0b, #ef4444`,floatClass:`float-a`,capabilities:[`Legal Information`,`FIR Templates`,`Rights Explanation`,`Contract Summary`,`Legal Research`],suggestions:[`Explain tenant rights`,`Draft a simple contract`,`What is an FIR?`],description:`Your legal information assistant for FIR templates, rights explanation, contract summaries, and legal research.`,system:`# SKILL.md — Lawyer Agent
...
|---------|------------|----------------------|
| 1.0.0   | 2025-01-01 | Initial release      |
`},{id:`learn`,name:`Learn AI`,role:`Adaptive educator`,color:`#ec4899`,gradient:`#ec4899, #8b5cf6`,floatClass:`float-b`,capabilities:[`Adaptive Teaching`,`Coding Tutor`,`Quiz Generator`,`Exam Preparation`,`Concept Explainer`],suggestions:[`Teach me Python basics`,`Quiz me on history`,`Create a study plan for math`],description:`Your enthusiastic adaptive educator for coding tuition, quiz generation, concept explanation, and exam prep.`,system:`# SKILL.md — Learning Agent
...
|---------|------------|----------------------|
| 1.0.0   | 2025-01-01 | Initial release      |
`}],re=({color:e,size:t=180})=>(0,x.jsxs)(`div`,{style:{width:t,height:t,position:`relative`,display:`flex`,alignItems:`center`,justifyContent:`center`,margin:`0 auto`},children:[(0,x.jsx)(`div`,{style:{position:`absolute`,width:t*.3,height:t*.3,backgroundColor:e,borderRadius:`50%`,filter:`blur(${t*.2}px)`,opacity:.8,zIndex:1}}),(0,x.jsx)(`div`,{style:{position:`absolute`,width:t*.5,height:t*.5,background:`radial-gradient(circle, #fff 10%, ${e} 40%, transparent 80%)`,borderRadius:`50%`,zIndex:2,opacity:.9,mixBlendMode:`screen`}}),(0,x.jsx)(`div`,{style:{position:`absolute`,width:`100%`,height:`100%`,border:`2px solid ${e}`,borderRadius:`50%`,borderTopColor:`transparent`,borderBottomColor:`transparent`,opacity:.4,zIndex:3,animation:`ring-spin 12s linear infinite`}}),(0,x.jsx)(`div`,{style:{position:`absolute`,width:`75%`,height:`75%`,border:`2px dashed ${e}`,borderRadius:`50%`,opacity:.6,zIndex:4,animation:`ring-spin 20s linear infinite reverse`}})]}),w=({onNavigate:e})=>{let[t,n]=(0,b.useState)(0),r=[`Intelligence that floats.`,`Your multi-agent operating system.`,`Productivity in zero gravity.`,`The future feels alive.`];return(0,b.useEffect)(()=>{let e=setInterval(()=>{n(e=>(e+1)%r.length)},4e3);return()=>clearInterval(e)},[]),(0,x.jsxs)(`div`,{style:{minHeight:`100vh`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,position:`relative`,overflow:`hidden`,padding:`80px 20px`},children:[(0,x.jsxs)(`div`,{style:{position:`absolute`,top:`40px`,display:`flex`,alignItems:`center`,gap:`8px`,padding:`6px 16px`,borderRadius:`20px`,background:`rgba(255,255,255,0.05)`,border:`1px solid rgba(255,255,255,0.1)`,backdropFilter:`blur(8px)`,zIndex:10},className:`slide-up`,children:[(0,x.jsx)(`span`,{className:`live-pulse-dot`}),(0,x.jsx)(`span`,{className:`font-mono`,style:{fontSize:`0.75rem`,color:`#a1a1aa`},children:`AGENTVERSE • v1.0.0`})]}),(0,x.jsxs)(`div`,{style:{display:`flex`,flexDirection:`row`,alignItems:`center`,justifyContent:`space-between`,maxWidth:`1200px`,width:`100%`,gap:`40px`,zIndex:10,marginBottom:`60px`,marginTop:`60px`,flexWrap:`wrap`},className:`slide-up`,children:[(0,x.jsxs)(`div`,{style:{flex:`1 1 500px`,textAlign:`left`},children:[(0,x.jsxs)(`h1`,{style:{fontSize:`clamp(3rem, 6vw, 5.5rem)`,lineHeight:1.1,marginBottom:`20px`,textShadow:`0 0 40px rgba(168,85,247,0.3)`,display:`inline-flex`,alignItems:`center`,gap:`24px`,flexWrap:`wrap`},children:[(0,x.jsx)(`img`,{src:`/logo.png`,alt:`Logo`,style:{width:`clamp(3.5rem, 7vw, 6.5rem)`,height:`clamp(3.5rem, 7vw, 6.5rem)`,borderRadius:`16px`,border:`2px solid var(--cyan)`,boxShadow:`0 0 30px rgba(34, 211, 238, 0.4)`}}),(0,x.jsxs)(`span`,{children:[`Agent`,(0,x.jsx)(`span`,{className:`grad-text`,children:`Verse`})]})]}),(0,x.jsxs)(`div`,{style:{fontSize:`1.25rem`,color:`#a1a1aa`,height:`30px`,marginBottom:`40px`},className:`font-mono`,children:[r[t],(0,x.jsx)(`span`,{style:{animation:`type-cursor 1s infinite`,marginLeft:`4px`,color:`var(--cyan)`},children:`_`})]}),(0,x.jsxs)(`div`,{style:{display:`flex`,gap:`16px`,justifyContent:`flex-start`},children:[(0,x.jsxs)(`button`,{className:`cyber-launch-btn`,onClick:()=>e(`dashboard`),children:[(0,x.jsx)(`div`,{className:`btn-corner btn-corner-tl`}),(0,x.jsx)(`div`,{className:`btn-corner btn-corner-tr`}),(0,x.jsx)(`div`,{className:`btn-corner btn-corner-bl`}),(0,x.jsx)(`div`,{className:`btn-corner btn-corner-br`}),(0,x.jsx)(`span`,{className:`live-pulse-dot`,style:{background:`#fff`,boxShadow:`0 0 8px #fff`,width:`6px`,height:`6px`}}),`Launch OS`]}),(0,x.jsx)(`button`,{className:`ghost-btn`,onClick:()=>e(`gallery`),children:`View OS`})]})]}),(0,x.jsxs)(`div`,{style:{flex:`1 1 400px`,display:`flex`,justifyContent:`center`,alignItems:`center`,position:`relative`,height:`450px`},children:[(0,x.jsx)(`div`,{style:{position:`absolute`,width:`320px`,height:`420px`,borderRadius:`24px`,background:`radial-gradient(circle, rgba(34,211,238,0.15) 0%, rgba(168,85,247,0.05) 60%, transparent 80%)`,filter:`blur(40px)`,zIndex:1}}),(0,x.jsxs)(`div`,{className:`float-c`,style:{zIndex:2,position:`relative`,width:`320px`,height:`420px`,background:`rgba(2, 4, 8, 0.45)`,backdropFilter:`blur(20px)`,borderRadius:`24px`,border:`1px solid rgba(34, 211, 238, 0.25)`,boxShadow:`0 0 50px rgba(34, 211, 238, 0.15), inset 0 0 25px rgba(34, 211, 238, 0.05)`,overflow:`hidden`,display:`flex`,alignItems:`center`,justifyContent:`center`,padding:`16px`},children:[(0,x.jsx)(`div`,{style:{position:`absolute`,top:0,left:0,right:0,bottom:0,backgroundImage:`linear-gradient(rgba(34,211,238,0.04) 1px, transparent 1px), linear-gradient(90deg, rgba(34,211,238,0.04) 1px, transparent 1px)`,backgroundSize:`16px 16px`,opacity:.8,pointerEvents:`none`,zIndex:1}}),(0,x.jsx)(`div`,{style:{position:`absolute`,top:`4%`,left:`4%`,right:`4%`,bottom:`4%`,border:`1px dashed rgba(34,211,238,0.2)`,borderRadius:`50%`,animation:`ring-spin 20s linear infinite`,pointerEvents:`none`,zIndex:3}}),(0,x.jsx)(`div`,{style:{position:`absolute`,top:`12%`,left:`12%`,right:`12%`,bottom:`12%`,border:`1.5px solid rgba(168,85,247,0.15)`,borderLeftColor:`transparent`,borderRightColor:`transparent`,borderRadius:`50%`,animation:`ring-spin 10s linear infinite reverse`,pointerEvents:`none`,zIndex:3}}),(0,x.jsxs)(`div`,{className:`font-mono`,style:{position:`absolute`,top:`16px`,left:`16px`,fontSize:`0.65rem`,color:`var(--cyan)`,opacity:.85,zIndex:4,lineHeight:`1.4`,letterSpacing:`0.05em`,textShadow:`0 0 5px rgba(34,211,238,0.3)`},children:[`SYS_LOC // [45.82 : 10.98]`,(0,x.jsx)(`br`,{}),`STATUS  // CORE_ACTIVE`,(0,x.jsx)(`br`,{}),`MODEL   // ROBO_V5`]}),(0,x.jsxs)(`div`,{className:`font-mono`,style:{position:`absolute`,bottom:`16px`,right:`16px`,fontSize:`0.65rem`,color:`var(--purple)`,opacity:.85,zIndex:4,lineHeight:`1.4`,letterSpacing:`0.05em`,textAlign:`right`,textShadow:`0 0 5px rgba(168,85,247,0.3)`},children:[`ROTATION // 360/s`,(0,x.jsx)(`br`,{}),`FPS_CAP  // 60_MAX`,(0,x.jsx)(`br`,{}),`INTEGRITY// 100%`]}),(0,x.jsx)(`div`,{style:{zIndex:5,position:`absolute`,top:`12px`,left:`12px`,width:`14px`,height:`14px`,borderTop:`2px solid var(--cyan)`,borderLeft:`2px solid var(--cyan)`,filter:`drop-shadow(0 0 5px var(--cyan))`}}),(0,x.jsx)(`div`,{style:{zIndex:5,position:`absolute`,top:`12px`,right:`12px`,width:`14px`,height:`14px`,borderTop:`2px solid var(--cyan)`,borderRight:`2px solid var(--cyan)`,filter:`drop-shadow(0 0 5px var(--cyan))`}}),(0,x.jsx)(`div`,{style:{zIndex:5,position:`absolute`,bottom:`12px`,left:`12px`,width:`14px`,height:`14px`,borderBottom:`2px solid var(--cyan)`,borderLeft:`2px solid var(--cyan)`,filter:`drop-shadow(0 0 5px var(--cyan))`}}),(0,x.jsx)(`div`,{style:{zIndex:5,position:`absolute`,bottom:`12px`,right:`12px`,width:`14px`,height:`14px`,borderBottom:`2px solid var(--cyan)`,borderRight:`2px solid var(--cyan)`,filter:`drop-shadow(0 0 5px var(--cyan))`}}),(0,x.jsx)(`div`,{style:{width:`100%`,height:`100%`,backgroundImage:`url(/robot.png)`,backgroundSize:`cover`,backgroundPosition:`center`,backgroundRepeat:`no-repeat`,borderRadius:`16px`,filter:`brightness(1.1) drop-shadow(0 0 15px rgba(34,211,238,0.2))`,zIndex:2}}),(0,x.jsx)(`div`,{style:{position:`absolute`,top:0,left:0,right:0,bottom:0,background:`linear-gradient(rgba(18, 16, 16, 0) 50%, rgba(0, 0, 0, 0.25) 50%)`,backgroundSize:`100% 4px`,pointerEvents:`none`,opacity:.5,zIndex:3}})]})]})]}),(0,x.jsx)(`div`,{style:{display:`flex`,justifyContent:`center`,alignItems:`center`,gap:`24px`,flexWrap:`wrap`,maxWidth:`1200px`,width:`100%`,padding:`0 20px`,zIndex:10,marginBottom:`40px`},children:ne.map((e,t)=>(0,x.jsxs)(`div`,{className:`agent-card ${e.floatClass} bounce-in`,style:{animationDelay:`${t*.15}s`,width:`200px`,"--agent-glow":e.color,display:`flex`,flexDirection:`column`,alignItems:`center`,textAlign:`center`},children:[(0,x.jsx)(re,{color:e.color,size:60}),(0,x.jsx)(`h3`,{style:{marginTop:`16px`,fontSize:`1.2rem`,color:e.color},children:e.name}),(0,x.jsx)(`p`,{style:{fontSize:`0.85rem`,color:`#a1a1aa`,marginTop:`8px`},children:e.role})]},e.id))}),(0,x.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,opacity:.5,marginTop:`20px`},children:[(0,x.jsx)(`span`,{className:`font-mono`,style:{fontSize:`0.7rem`,marginBottom:`8px`,letterSpacing:`0.1em`},children:`INITIATE`}),(0,x.jsx)(`div`,{style:{width:`1px`,height:`40px`,background:`linear-gradient(to bottom, var(--cyan), transparent)`}})]}),(0,x.jsx)(`style`,{dangerouslySetInnerHTML:{__html:`
      ...
      `}})]})},ie=({onNavigate:e,onSelectAgent:t})=>(0,x.jsxs)(`div`,{style:{padding:`40px`,maxWidth:`1400px`,margin:`0 auto`},className:`slide-up`,children:[(0,x.jsxs)(`header`,{style:{marginBottom:`40px`,borderBottom:`1px solid rgba(34,211,238,0.1)`,paddingBottom:`24px`,display:`flex`,justifyContent:`space-between`,alignItems:`flex-end`,flexWrap:`wrap`,gap:`20px`},children:[(0,x.jsxs)(`div`,{children:[(0,x.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`12px`},children:[(0,x.jsx)(`div`,{style:{width:`4px`,height:`32px`,background:`var(--cyan)`,borderRadius:`2px`,boxShadow:`0 0 10px var(--cyan)`}}),(0,x.jsxs)(`h1`,{className:`font-hero`,style:{fontSize:`2.5rem`,margin:0,tracking:`0.02em`},children:[`Welcome back, `,(0,x.jsx)(`span`,{className:`grad-text`,children:`Commander`})]})]}),(0,x.jsx)(`p`,{className:`font-mono`,style:{color:`#a1a1aa`,marginTop:`8px`,fontSize:`0.85rem`,letterSpacing:`0.05em`},children:`STATUS // ALL SYSTEMS NOMINAL • CORE MODULES ONLINE`})]}),(0,x.jsxs)(`div`,{className:`font-mono`,style:{border:`1px solid rgba(168,85,247,0.3)`,background:`rgba(168,85,247,0.05)`,padding:`10px 20px`,borderRadius:`4px`,fontSize:`0.75rem`,color:`var(--purple)`,textAlign:`right`,lineHeight:`1.4`,letterSpacing:`0.08em`,position:`relative`},children:[(0,x.jsx)(`div`,{style:{position:`absolute`,top:`-1px`,left:`-1px`,width:`4px`,height:`4px`,borderTop:`1px solid var(--purple)`,borderLeft:`1px solid var(--purple)`}}),(0,x.jsx)(`div`,{style:{position:`absolute`,bottom:`-1px`,right:`-1px`,width:`4px`,height:`4px`,borderBottom:`1px solid var(--purple)`,borderRight:`1px solid var(--purple)`}}),`SYS_LATENCY // 12ms`,(0,x.jsx)(`br`,{}),`SECTOR_LOC  // ORBIT_04`]})]}),(0,x.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(auto-fit, minmax(220px, 1fr))`,gap:`20px`,marginBottom:`60px`},children:[{label:`Messages`,value:`1,204`},{label:`Sessions`,value:`42`},{label:`Agents Used`,value:`5/5`},{label:`Time Saved`,value:`84h`}].map((e,t)=>(0,x.jsxs)(`div`,{className:`agent-card`,style:{padding:`24px`,display:`flex`,flexDirection:`column`,gap:`8px`,position:`relative`,background:`rgba(2,4,8,0.4)`,border:`1px solid rgba(34,211,238,0.15)`,borderRadius:`8px`,overflow:`hidden`},children:[(0,x.jsx)(`div`,{style:{position:`absolute`,top:`8px`,left:`8px`,width:`8px`,height:`8px`,borderTop:`1.5px solid var(--cyan)`,borderLeft:`1.5px solid var(--cyan)`}}),(0,x.jsx)(`div`,{style:{position:`absolute`,top:`8px`,right:`8px`,width:`8px`,height:`8px`,borderTop:`1.5px solid var(--cyan)`,borderRight:`1.5px solid var(--cyan)`}}),(0,x.jsx)(`div`,{style:{position:`absolute`,bottom:`8px`,left:`8px`,width:`8px`,height:`8px`,borderBottom:`1.5px solid var(--cyan)`,borderLeft:`1.5px solid var(--cyan)`}}),(0,x.jsx)(`div`,{style:{position:`absolute`,bottom:`8px`,right:`8px`,width:`8px`,height:`8px`,borderBottom:`1.5px solid var(--cyan)`,borderRight:`1.5px solid var(--cyan)`}}),(0,x.jsxs)(`span`,{className:`font-mono`,style:{color:`var(--cyan)`,fontSize:`0.75rem`,letterSpacing:`0.08em`,textTransform:`uppercase`,opacity:.8},children:[`[STAT_0`,t+1,`] // `,e.label]}),(0,x.jsx)(`span`,{className:`font-hero`,style:{fontSize:`2.4rem`,color:`#fff`,textShadow:`0 0 15px rgba(255,255,255,0.15)`,margin:`8px 0`},children:e.value}),(0,x.jsx)(`div`,{style:{position:`absolute`,bottom:0,left:0,right:0,height:`2px`,background:`linear-gradient(90deg, transparent, var(--cyan), transparent)`,opacity:.4}})]},t))}),(0,x.jsxs)(`h2`,{className:`font-hero`,style:{fontSize:`1.5rem`,marginBottom:`28px`,display:`flex`,alignItems:`center`,gap:`12px`,letterSpacing:`0.05em`},children:[(0,x.jsx)(`span`,{className:`live-pulse-dot`,style:{background:`var(--cyan)`,boxShadow:`0 0 10px var(--cyan)`}}),`ACTIVE MODULES`]}),(0,x.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(auto-fit, minmax(320px, 1fr))`,gap:`28px`},children:ne.map((n,r)=>(0,x.jsxs)(`div`,{className:`agent-card bounce-in`,style:{animationDelay:`${r*.1}s`,"--agent-glow":n.color,display:`flex`,flexDirection:`column`,gap:`16px`,position:`relative`,border:`1px solid rgba(${n.color===`var(--cyan)`?`34,211,238`:`168,85,247`}, 0.25)`,background:`rgba(2,4,8,0.5)`,backdropFilter:`blur(10px)`,borderRadius:`12px`,padding:`28px`},children:[(0,x.jsx)(`div`,{style:{position:`absolute`,top:`10px`,left:`10px`,width:`10px`,height:`10px`,borderTop:`2px solid ${n.color}`,borderLeft:`2px solid ${n.color}`}}),(0,x.jsx)(`div`,{style:{position:`absolute`,top:`10px`,right:`10px`,width:`10px`,height:`10px`,borderTop:`2px solid ${n.color}`,borderRight:`2px solid ${n.color}`}}),(0,x.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`20px`},children:[(0,x.jsx)(`div`,{style:{width:`60px`,height:`60px`,flexShrink:0},children:(0,x.jsx)(re,{color:n.color,size:60})}),(0,x.jsxs)(`div`,{style:{flex:1},children:[(0,x.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`space-between`},children:[(0,x.jsx)(`h3`,{className:`font-hero`,style:{fontSize:`1.25rem`,color:n.color,margin:0,letterSpacing:`0.02em`},children:n.name}),(0,x.jsxs)(`span`,{className:`font-mono`,style:{fontSize:`0.65rem`,color:`#71717a`},children:[`[MOD_0`,r+1,`]`]})]}),(0,x.jsx)(`span`,{className:`font-mono`,style:{fontSize:`0.75rem`,color:`#a1a1aa`,letterSpacing:`0.05em`,textTransform:`uppercase`,marginTop:`4px`,display:`block`},children:n.role})]})]}),(0,x.jsx)(`p`,{style:{color:`#d4d4d8`,fontSize:`0.9rem`,lineHeight:1.6,flex:1,margin:0},children:n.description}),(0,x.jsxs)(`button`,{className:`cyber-launch-btn`,style:{"--btn-theme":n.color,background:`linear-gradient(135deg, rgba(${n.color===`var(--cyan)`?`34,211,238`:`168,85,247`}, 0.05) 0%, rgba(${n.color===`var(--cyan)`?`34,211,238`:`168,85,247`}, 0.15) 100%)`,border:`1px solid ${n.color}`,boxShadow:`0 0 15px rgba(${n.color===`var(--cyan)`?`34,211,238`:`168,85,247`}, 0.1)`,padding:`12px 20px`,borderRadius:`6px`,fontFamily:`var(--font-mono)`,fontSize:`0.8rem`,letterSpacing:`0.08em`,cursor:`none`,position:`relative`,width:`100%`,display:`flex`,alignItems:`center`,justifyContent:`center`,gap:`8px`,color:`#fff`,textTransform:`uppercase`,transition:`all 0.3s`},onClick:()=>{t(n.id),e(`chat`)},children:[(0,x.jsx)(`div`,{style:{position:`absolute`,top:`-1px`,left:`-1px`,width:`4px`,height:`4px`,borderTop:`1px solid ${n.color}`,borderLeft:`1px solid ${n.color}`}}),(0,x.jsx)(`div`,{style:{position:`absolute`,top:`-1px`,right:`-1px`,width:`4px`,height:`4px`,borderTop:`1px solid ${n.color}`,borderRight:`1px solid ${n.color}`}}),(0,x.jsx)(`div`,{style:{position:`absolute`,bottom:`-1px`,left:`-1px`,width:`4px`,height:`4px`,borderBottom:`1px solid ${n.color}`,borderLeft:`1px solid ${n.color}`}}),(0,x.jsx)(`div`,{style:{position:`absolute`,bottom:`-1px`,right:`-1px`,width:`4px`,height:`4px`,borderBottom:`1px solid ${n.color}`,borderRight:`1px solid ${n.color}`}}),(0,x.jsx)(`span`,{className:`live-pulse-dot`,style:{background:n.color,boxShadow:`0 0 8px ${n.color}`,width:`5px`,height:`5px`}}),`Launch OS`]})]},n.id))})]}),ae=({onNavigate:e,onSelectAgent:t})=>(0,x.jsxs)(`div`,{style:{padding:`40px`,maxWidth:`1200px`,margin:`0 auto`},className:`slide-up`,children:[(0,x.jsxs)(`header`,{style:{marginBottom:`40px`},children:[(0,x.jsxs)(`h1`,{style:{fontSize:`2.5rem`},children:[`Agent `,(0,x.jsx)(`span`,{className:`grad-text`,children:`Gallery`})]}),(0,x.jsx)(`p`,{style:{color:`#a1a1aa`,marginTop:`8px`},children:`Explore the specialized intelligence modules.`})]}),(0,x.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`40px`},children:ne.map((n,r)=>(0,x.jsxs)(`div`,{className:`agent-card slide-up`,style:{display:`flex`,flexDirection:`row`,alignItems:`center`,gap:`40px`,animationDelay:`${r*.15}s`,padding:`40px`,flexWrap:`wrap`},children:[(0,x.jsx)(`div`,{style:{flex:`0 0 auto`},children:(0,x.jsx)(re,{color:n.color,size:150})}),(0,x.jsxs)(`div`,{style:{flex:1,minWidth:`300px`},children:[(0,x.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`12px`,marginBottom:`8px`},children:[(0,x.jsx)(`h2`,{style:{fontSize:`2rem`,color:n.color},children:n.name}),(0,x.jsx)(`div`,{style:{padding:`4px 12px`,borderRadius:`12px`,border:`1px solid ${n.color}`,background:`rgba(${n.color}, 0.1)`,color:n.color,fontSize:`0.75rem`,textTransform:`uppercase`},className:`font-mono`,children:n.role})]}),(0,x.jsx)(`p`,{style:{color:`#d4d4d8`,fontSize:`1rem`,lineHeight:1.6,marginBottom:`24px`},children:n.description}),(0,x.jsxs)(`div`,{style:{marginBottom:`24px`},children:[(0,x.jsx)(`h4`,{style:{color:`#a1a1aa`,marginBottom:`12px`,fontSize:`0.85rem`,textTransform:`uppercase`},className:`font-mono`,children:`Capabilities`}),(0,x.jsx)(`div`,{style:{display:`flex`,flexWrap:`wrap`,gap:`8px`},children:n.capabilities.map((e,t)=>(0,x.jsx)(`span`,{style:{background:`rgba(255,255,255,0.05)`,border:`1px solid rgba(255,255,255,0.1)`,padding:`6px 12px`,borderRadius:`16px`,fontSize:`0.85rem`},children:e},t))})]}),(0,x.jsxs)(`button`,{style:{background:`linear-gradient(90deg, ${n.gradient})`,border:`none`,padding:`12px 24px`,borderRadius:`8px`,color:`#fff`,fontFamily:`var(--font-mono)`,fontSize:`0.9rem`,textTransform:`uppercase`,letterSpacing:`0.05em`,cursor:`none`,display:`inline-flex`,alignItems:`center`,gap:`8px`,boxShadow:`0 0 20px rgba(0,0,0,0.3)`},onClick:()=>{t(n.id),e(`chat`)},children:[(0,x.jsx)(`span`,{className:`live-pulse-dot`,style:{background:`#fff`,boxShadow:`none`,width:`6px`,height:`6px`}}),`Launch OS`]})]})]},n.id))})]}),oe=e=>{if(!e)return``;let t=e.split(`
`),n=[],r=!1,i=!1,a=!1,o=null,s=[],c=e=>e.replace(/\*\*(.*?)\*\*/g,`<strong>$1</strong>`).replace(/\*(.*?)\*/g,`<em>$1</em>`).replace(/`(.*?)`/g,`<code style="font-family: var(--font-mono); background: rgba(255,255,255,0.1); padding: 2px 6px; border-radius: 4px; font-size: 0.85em; color: var(--cyan); border: 1px solid rgba(255,255,255,0.05)">$1</code>`);for(let e=0;e<t.length;e++){let l=t[e];if(l.startsWith("```")){if(i)n.push(`</pre></div>`),i=!1;else{let e=l.slice(3).trim()||`code`;n.push(`<div style="background: rgba(0,0,0,0.3); border: 1px solid rgba(255,255,255,0.05); border-radius: 8px; margin: 12px 0; overflow: hidden;"><div style="background: rgba(255,255,255,0.02); padding: 6px 16px; border-bottom: 1px solid rgba(255,255,255,0.05); font-family: var(--font-mono); font-size: 0.75rem; color: #a1a1aa; display: flex; justify-content: space-between;"><span>${e}</span></div><pre style="padding: 16px; font-family: var(--font-mono); font-size: 0.9rem; overflow-x: auto; margin: 0; color: #e4e4e7;">`),i=!0}continue}if(i){n.push(l.replace(/</g,`&lt;`).replace(/>/g,`&gt;`)+`
`);continue}if(l.trim().startsWith(`|`)){let e=l.split(`|`).map(e=>e.trim()).filter((e,t,n)=>t>0&&t<n.length-1);if(e.every(e=>/^:-*|-*:-*|-*:$/.test(e)||e===``))continue;a?s.push(e):(a=!0,o=e);continue}else if(a){let e=`<div style="overflow-x: auto; margin: 16px 0; border: 1px solid rgba(255,255,255,0.05); border-radius: 8px;"><table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 0.9rem;">`;o&&(e+=`<thead style="background: rgba(255,255,255,0.02); border-bottom: 1px solid rgba(255,255,255,0.1);"><tr>`,o.forEach(t=>{e+=`<th style="padding: 12px 16px; font-weight: 600; color: var(--cyan);">${c(t)}</th>`}),e+=`</tr></thead>`),e+=`<tbody>`,s.forEach(t=>{e+=`<tr style="border-bottom: 1px solid rgba(255,255,255,0.05); transition: background 0.2s;">`,t.forEach(t=>{e+=`<td style="padding: 12px 16px; color: #d4d4d8;">${c(t)}</td>`}),e+=`</tr>`}),e+=`</tbody></table></div>`,n.push(e),a=!1,o=null,s=[]}if(l.trim().startsWith(`- `)||l.trim().startsWith(`* `)){r||=(n.push(`<ul style="margin: 12px 0 12px 24px; list-style-type: disc; display: flex; flex-direction: column; gap: 6px;">`),!0);let e=l.trim().slice(2);n.push(`<li style="color: #d4d4d8;">${c(e)}</li>`);continue}else if(/^\d+\.\s/.test(l.trim())){r||=(n.push(`<ol style="margin: 12px 0 12px 24px; display: flex; flex-direction: column; gap: 6px;">`),!0);let e=l.trim().match(/^(\d+)\.\s(.*)/)[2];n.push(`<li style="color: #d4d4d8;">${c(e)}</li>`);continue}else r&&=(n.push(`</ul>`),!1);l.startsWith(`### `)?n.push(`<h3 style="font-size: 1.25rem; color: var(--cyan); margin: 24px 0 12px 0; font-family: var(--font-hero); font-weight: 700;">${c(l.slice(4))}</h3>`):l.startsWith(`## `)?n.push(`<h2 style="font-size: 1.5rem; color: var(--purple); margin: 28px 0 16px 0; font-family: var(--font-hero); font-weight: 800; border-bottom: 1px solid rgba(255,255,255,0.05); padding-bottom: 8px;">${c(l.slice(3))}</h2>`):l.startsWith(`# `)?n.push(`<h1 style="font-size: 1.8rem; color: #fff; margin: 32px 0 20px 0; font-family: var(--font-hero); font-weight: 800;">${c(l.slice(2))}</h1>`):l.trim()===``?n.push(`<div style="height: 12px;"></div>`):n.push(`<p style="margin: 8px 0; color: #e4e4e7; line-height: 1.6;">${c(l)}</p>`)}if(i&&n.push(`</pre></div>`),r&&n.push(`</ul>`),a){let e=`<div style="overflow-x: auto; margin: 16px 0; border: 1px solid rgba(255,255,255,0.05); border-radius: 8px;"><table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 0.9rem;">`;o&&(e+=`<thead style="background: rgba(255,255,255,0.02); border-bottom: 1px solid rgba(255,255,255,0.1);"><tr>`,o.forEach(t=>{e+=`<th style="padding: 12px 16px; font-weight: 600; color: var(--cyan);">${c(t)}</th>`}),e+=`</tr></thead>`),e+=`<tbody>`,s.forEach(t=>{e+=`<tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">`,t.forEach(t=>{e+=`<td style="padding: 12px 16px; color: #d4d4d8;">${c(t)}</td>`}),e+=`</tr>`}),e+=`</tbody></table></div>`,n.push(e)}return n.join(``)},se=({activeAgentId:e,onSelectAgent:t})=>{let[n,r]=(0,b.useState)(ne.find(t=>t.id===e)||ne[0]),[i,a]=(0,b.useState)([]),[o,s]=(0,b.useState)(``),[c,l]=(0,b.useState)(!1),u=(0,b.useRef)(null);(0,b.useEffect)(()=>{let t=ne.find(t=>t.id===e);t&&(r(t),a([]))},[e]),(0,b.useEffect)(()=>{u.current&&(u.current.scrollTop=u.current.scrollHeight)},[i,c]);let d=async(e=o)=>{if(!e.trim()||c)return;let t=localStorage.getItem(`api_provider`)||`groq`,r=e=>!e||e===`your_groq_api_key_here`||e===`your_gemini_api_key_here`||e===`your_api_key_here`?``:e.trim(),u=r(localStorage.getItem(`groq_api_key`)||window.STREAMLIT_ENV&&window.STREAMLIT_ENV.VITE_GROQ_API_KEY||`your_groq_api_key_here`),d=r(localStorage.getItem(`gemini_api_key`)||window.STREAMLIT_ENV&&window.STREAMLIT_ENV.VITE_GEMINI_API_KEY||`your_gemini_api_key_here`),f,p;if(t===`groq`?(f=u,p=`Error: No Groq API key found. Please configure in Settings.`):(f=d,p=`Error: No Gemini API key found. Please configure in Settings.`),!f){a(t=>[...t,{role:`user`,content:e},{role:`assistant`,content:p}]),s(``);return}let m=[...i,{role:`user`,content:e}];a(m),s(``),l(!0);try{let e,r;if(t===`groq`){let t=[{role:`system`,content:n.system},...m.map(e=>({role:e.role===`assistant`?`assistant`:`user`,content:e.content}))];e=await fetch(`https://api.groq.com/openai/v1/chat/completions`,{method:`POST`,headers:{Authorization:`Bearer ${f}`,"Content-Type":`application/json`},body:JSON.stringify({model:`llama-3.3-70b-versatile`,messages:t,max_tokens:1e3,temperature:.7})}),r=await e.json(),e.ok&&r.choices?.[0]?.message?.content?a(e=>[...e,{role:`assistant`,content:r.choices[0].message.content}]):a(e=>[...e,{role:`assistant`,content:`API Error: ${r.error?.message||`Unknown error`}`}])}else{let t=m.map(e=>({role:e.role===`assistant`?`model`:`user`,parts:[{text:e.content}]}));e=await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=${f}`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({contents:t,systemInstruction:{parts:[{text:n.system}]},generationConfig:{maxOutputTokens:1e3}})}),r=await e.json(),e.ok&&r.candidates&&r.candidates[0]?.content?.parts?.[0]?.text?a(e=>[...e,{role:`assistant`,content:r.candidates[0].content.parts[0].text}]):a(e=>[...e,{role:`assistant`,content:`API Error: ${r.error?.message||`Unknown error`}`}])}}catch(e){a(t=>[...t,{role:`assistant`,content:`Connection Error: ${e.message}`}])}finally{l(!1)}};return(0,x.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,height:`100%`,maxWidth:`1000px`,margin:`0 auto`,padding:`20px`},children:[(0,x.jsx)(`div`,{style:{display:`flex`,gap:`12px`,marginBottom:`20px`,overflowX:`auto`,paddingBottom:`10px`},className:`chat-scroll`,children:ne.map(e=>(0,x.jsx)(`button`,{onClick:()=>t(e.id),style:{background:e.id===n.id?`rgba(${e.color.replace(`#`,``)}, 0.1)`:`transparent`,border:`1px solid ${e.id===n.id?e.color:`rgba(255,255,255,0.1)`}`,color:e.id===n.id?e.color:`#a1a1aa`,padding:`6px 16px`,borderRadius:`20px`,cursor:`none`,fontFamily:`var(--font-mono)`,fontSize:`0.85rem`,whiteSpace:`nowrap`,transition:`all 0.3s`},children:e.name},e.id))}),(0,x.jsx)(`div`,{ref:u,className:`chat-scroll`,style:{flex:1,overflowY:`auto`,display:`flex`,flexDirection:`column`,gap:`24px`,paddingRight:`12px`},children:i.length===0?(0,x.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,flex:1,opacity:.8},className:`slide-up`,children:[(0,x.jsx)(re,{color:n.color,size:100}),(0,x.jsx)(`h2`,{style:{color:n.color,marginTop:`24px`,fontSize:`1.5rem`},children:n.name}),(0,x.jsx)(`p`,{style:{color:`#a1a1aa`,marginTop:`8px`},children:n.role}),(0,x.jsx)(`div`,{style:{display:`flex`,flexWrap:`wrap`,gap:`12px`,justifyContent:`center`,marginTop:`40px`},children:n.suggestions.map((e,t)=>(0,x.jsx)(`button`,{className:`ghost-btn`,style:{fontSize:`0.8rem`,padding:`8px 16px`,borderRadius:`20px`},onClick:()=>d(e),children:e},t))})]}):(0,x.jsxs)(x.Fragment,{children:[i.map((e,t)=>(0,x.jsxs)(`div`,{className:e.role===`user`?`slide-up`:`slide-in-left`,style:{alignSelf:e.role===`user`?`flex-end`:`flex-start`,maxWidth:`80%`,display:`flex`,gap:`16px`,flexDirection:e.role===`user`?`row-reverse`:`row`},children:[e.role===`assistant`&&(0,x.jsx)(`div`,{style:{width:`40px`,height:`40px`,flexShrink:0},children:(0,x.jsx)(re,{color:n.color,size:40})}),(0,x.jsx)(`div`,{style:{background:e.role===`user`?`rgba(255,255,255,0.05)`:`transparent`,border:e.role===`user`?`1px solid rgba(255,255,255,0.1)`:`none`,padding:e.role===`user`?`16px 20px`:`8px 0`,borderRadius:e.role===`user`?`20px 20px 0 20px`:`0`,color:`#e4e4e7`,lineHeight:1.6,whiteSpace:e.role===`user`?`pre-wrap`:`normal`,width:`100%`},children:e.role===`assistant`?(0,x.jsx)(`div`,{dangerouslySetInnerHTML:{__html:oe(e.content)}}):e.content})]},t)),c&&(0,x.jsxs)(`div`,{className:`slide-in-left`,style:{display:`flex`,gap:`16px`},children:[(0,x.jsx)(`div`,{style:{width:`40px`,height:`40px`,flexShrink:0},children:(0,x.jsx)(re,{color:n.color,size:40})}),(0,x.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`4px`,padding:`8px 0`},children:[0,1,2].map(e=>(0,x.jsx)(`div`,{style:{width:`6px`,height:`6px`,borderRadius:`50%`,background:n.color,animation:`thinking-dot 1s infinite ease-in-out ${e*.2}s`}},e))})]})]})}),(0,x.jsxs)(`div`,{style:{marginTop:`20px`,position:`relative`},className:`slide-up`,children:[(0,x.jsx)(`textarea`,{value:o,onChange:e=>s(e.target.value),onKeyDown:e=>{e.key===`Enter`&&!e.shiftKey&&(e.preventDefault(),d())},placeholder:`Initiate prompt...`,style:{width:`100%`,background:`rgba(255,255,255,0.02)`,border:`1px solid ${n.color}`,borderRadius:`16px`,padding:`16px 60px 16px 20px`,color:`#fff`,fontFamily:`var(--font-body)`,fontSize:`1rem`,resize:`none`,outline:`none`,minHeight:`60px`,maxHeight:`200px`,boxShadow:`0 0 20px rgba(${n.color.replace(`#`,``)}, 0.1)`,cursor:`none`},className:`chat-scroll`}),(0,x.jsx)(`button`,{onClick:()=>d(),style:{position:`absolute`,right:`12px`,bottom:`14px`,background:n.color,border:`none`,width:`36px`,height:`36px`,borderRadius:`50%`,color:`#020408`,display:`flex`,alignItems:`center`,justifyContent:`center`,cursor:`none`,opacity:o.trim()&&!c?1:.5},children:`↑`})]})]})},ce=()=>{let[e,t]=(0,b.useState)(``),[n,r]=(0,b.useState)(``),[i,a]=(0,b.useState)(`groq`),[o,s]=(0,b.useState)(!0),[c,l]=(0,b.useState)(!1);(0,b.useEffect)(()=>{let e=e=>!e||e===`your_groq_api_key_here`||e===`your_gemini_api_key_here`||e===`your_api_key_here`?``:e.trim(),n=e(localStorage.getItem(`gemini_api_key`)),i=e(window.STREAMLIT_ENV&&window.STREAMLIT_ENV.VITE_GEMINI_API_KEY||`your_gemini_api_key_here`);t(n||i);let o=e(localStorage.getItem(`groq_api_key`)),s=e(window.STREAMLIT_ENV&&window.STREAMLIT_ENV.VITE_GROQ_API_KEY||`your_groq_api_key_here`);r(o||s),a(localStorage.getItem(`api_provider`)||`groq`)},[]);let u=e=>{let n=e.target.value;t(n),localStorage.setItem(`gemini_api_key`,n)},d=e=>{let t=e.target.value;r(t),localStorage.setItem(`groq_api_key`,t)},f=e=>{a(e),localStorage.setItem(`api_provider`,e)},p=({active:e,onChange:t,color:n=`var(--cyan)`})=>(0,x.jsx)(`div`,{style:{width:`50px`,height:`26px`,background:e?n:`rgba(255,255,255,0.1)`,borderRadius:`13px`,position:`relative`,transition:`background 0.3s`,boxShadow:e?`0 0 12px ${n}`:`none`},onClick:t,children:(0,x.jsx)(`div`,{style:{width:`22px`,height:`22px`,background:`#fff`,borderRadius:`50%`,position:`absolute`,top:`2px`,left:e?`26px`:`2px`,transition:`left 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275)`}})});return(0,x.jsxs)(`div`,{style:{padding:`40px`,maxWidth:`800px`,margin:`0 auto`},className:`slide-up`,children:[(0,x.jsxs)(`header`,{style:{marginBottom:`40px`},children:[(0,x.jsxs)(`h1`,{style:{fontSize:`2.5rem`},children:[`System `,(0,x.jsx)(`span`,{className:`grad-text`,children:`Settings`})]}),(0,x.jsx)(`p`,{style:{color:`#a1a1aa`,marginTop:`8px`},children:`Configure your AgentVerse environment.`})]}),(0,x.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`24px`},children:[(0,x.jsxs)(`div`,{className:`agent-card`,style:{borderLeft:`4px solid var(--purple)`,padding:`30px`},children:[(0,x.jsx)(`h3`,{style:{fontSize:`1.2rem`,marginBottom:`8px`,color:`var(--purple)`},children:`AI Provider`}),(0,x.jsx)(`p`,{style:{color:`#a1a1aa`,fontSize:`0.9rem`,marginBottom:`20px`},children:`Select which AI provider to use for agent responses.`}),(0,x.jsxs)(`div`,{style:{display:`flex`,gap:`12px`},children:[(0,x.jsx)(`button`,{onClick:()=>f(`groq`),style:{flex:1,padding:`12px`,background:i===`groq`?`var(--purple)`:`rgba(255,255,255,0.05)`,border:`1px solid ${i===`groq`?`var(--purple)`:`rgba(255,255,255,0.1)`}`,borderRadius:`8px`,color:`#fff`,cursor:`none`,fontFamily:`var(--font-mono)`,fontSize:`0.9rem`},children:`Groq (Fast)`}),(0,x.jsx)(`button`,{onClick:()=>f(`gemini`),style:{flex:1,padding:`12px`,background:i===`gemini`?`var(--purple)`:`rgba(255,255,255,0.05)`,border:`1px solid ${i===`gemini`?`var(--purple)`:`rgba(255,255,255,0.1)`}`,borderRadius:`8px`,color:`#fff`,cursor:`none`,fontFamily:`var(--font-mono)`,fontSize:`0.9rem`},children:`Gemini`})]})]}),(0,x.jsxs)(`div`,{className:`agent-card`,style:{borderLeft:`4px solid var(--purple)`,padding:`30px`},children:[(0,x.jsx)(`h3`,{style:{fontSize:`1.2rem`,marginBottom:`8px`,color:`var(--purple)`},children:`Groq API Key`}),(0,x.jsx)(`p`,{style:{color:`#a1a1aa`,fontSize:`0.9rem`,marginBottom:`20px`},children:`Required for agent intelligence. Your key is stored locally in your browser.`}),(0,x.jsx)(`input`,{type:`password`,value:n,onChange:d,placeholder:`gsk_...`,style:{width:`100%`,background:`rgba(0,0,0,0.5)`,border:`1px solid ${i===`groq`?`var(--purple)`:`rgba(255,255,255,0.1)`}`,padding:`12px 16px`,borderRadius:`8px`,color:`#fff`,fontFamily:`var(--font-mono)`,outline:`none`,cursor:`none`},onFocus:e=>e.target.style.borderColor=`var(--purple)`,onBlur:e=>e.target.style.borderColor=i===`groq`?`var(--purple)`:`rgba(255,255,255,0.1)`})]}),(0,x.jsxs)(`div`,{className:`agent-card`,style:{borderLeft:`4px solid var(--cyan)`,padding:`30px`},children:[(0,x.jsx)(`h3`,{style:{fontSize:`1.2rem`,marginBottom:`8px`,color:`var(--cyan)`},children:`Gemini API Key`}),(0,x.jsx)(`p`,{style:{color:`#a1a1aa`,fontSize:`0.9rem`,marginBottom:`20px`},children:`Alternative AI provider. Your key is stored locally in your browser.`}),(0,x.jsx)(`input`,{type:`password`,value:e,onChange:u,placeholder:`AIzaSy...`,style:{width:`100%`,background:`rgba(0,0,0,0.5)`,border:`1px solid ${i===`gemini`?`var(--cyan)`:`rgba(255,255,255,0.1)`}`,padding:`12px 16px`,borderRadius:`8px`,color:`#fff`,fontFamily:`var(--font-mono)`,outline:`none`,cursor:`none`},onFocus:e=>e.target.style.borderColor=`var(--cyan)`,onBlur:e=>e.target.style.borderColor=i===`gemini`?`var(--cyan)`:`rgba(255,255,255,0.1)`})]}),(0,x.jsxs)(`div`,{className:`agent-card`,style:{borderLeft:`4px solid var(--cyan)`,padding:`30px`},children:[(0,x.jsx)(`h3`,{style:{fontSize:`1.2rem`,marginBottom:`24px`,color:`var(--cyan)`},children:`Interface Preferences`}),(0,x.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`center`,marginBottom:`24px`},children:[(0,x.jsxs)(`div`,{children:[(0,x.jsx)(`h4`,{style:{fontSize:`1rem`,marginBottom:`4px`},children:`Antigravity Physics`}),(0,x.jsx)(`p`,{style:{color:`#a1a1aa`,fontSize:`0.85rem`},children:`Enable floating animations and cursor physics`})]}),(0,x.jsx)(p,{active:o,onChange:()=>s(!o),color:`var(--cyan)`})]}),(0,x.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`center`},children:[(0,x.jsxs)(`div`,{children:[(0,x.jsx)(`h4`,{style:{fontSize:`1rem`,marginBottom:`4px`},children:`Holographic Audio`}),(0,x.jsx)(`p`,{style:{color:`#a1a1aa`,fontSize:`0.85rem`},children:`Sound effects for clicks, hovers, and messages`})]}),(0,x.jsx)(p,{active:c,onChange:()=>l(!c),color:`var(--pink)`})]})]})]}),(0,x.jsx)(`footer`,{style:{marginTop:`60px`,textAlign:`center`,opacity:.6},children:(0,x.jsxs)(`p`,{className:`font-mono`,style:{fontSize:`0.8rem`},children:[`Agent`,(0,x.jsx)(`span`,{className:`grad-text`,children:`Verse`}),` OS v1.0.0`]})})]})};function le(){let[e,t]=(0,b.useState)(`landing`),[n,r]=(0,b.useState)(ne[0].id),i=()=>{switch(e){case`landing`:return(0,x.jsx)(w,{onNavigate:t});case`dashboard`:return(0,x.jsx)(ie,{onNavigate:t,onSelectAgent:r});case`gallery`:return(0,x.jsx)(ae,{onNavigate:t,onSelectAgent:r});case`chat`:return(0,x.jsx)(se,{activeAgentId:n,onSelectAgent:r});case`settings`:return(0,x.jsx)(ce,{});default:return(0,x.jsx)(w,{onNavigate:t})}},a=[{id:`dashboard`,label:`Dashboard`,icon:`⊞`},{id:`gallery`,label:`Gallery`,icon:`✦`},{id:`chat`,label:`Comms`,icon:`💬`},{id:`settings`,label:`Settings`,icon:`⚙`}];return e===`landing`?(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(ee,{}),(0,x.jsx)(S,{}),(0,x.jsx)(`div`,{className:`mesh-bg`}),(0,x.jsx)(C,{}),(0,x.jsx)(te,{currentPage:e}),i()]}):(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(ee,{}),(0,x.jsx)(S,{}),(0,x.jsx)(`div`,{className:`mesh-bg`}),(0,x.jsx)(C,{}),(0,x.jsx)(te,{currentPage:e}),(0,x.jsxs)(`div`,{style:{display:`flex`,minHeight:`100vh`},children:[(0,x.jsxs)(`aside`,{className:`desktop-sidebar`,style:{width:`240px`,background:`rgba(2,4,8,0.8)`,borderRight:`1px solid rgba(255,255,255,0.05)`,backdropFilter:`blur(20px)`,display:`flex`,flexDirection:`column`,position:`fixed`,top:0,bottom:0,left:0,zIndex:100},children:[(0,x.jsxs)(`div`,{style:{padding:`24px`,display:`flex`,alignItems:`center`,gap:`12px`},children:[(0,x.jsx)(`img`,{src:`/logo.png`,alt:`AgentVerse Logo`,style:{width:`32px`,height:`32px`,borderRadius:`8px`,boxShadow:`0 0 10px rgba(34, 211, 238, 0.3)`,border:`1px solid rgba(255,255,255,0.1)`}}),(0,x.jsx)(`h2`,{className:`font-hero`,style:{fontSize:`1.2rem`,letterSpacing:`0.05em`},children:`AgentVerse`})]}),(0,x.jsxs)(`nav`,{style:{flex:1,padding:`24px 0`},children:[a.map(n=>(0,x.jsxs)(`button`,{onClick:()=>t(n.id),style:{width:`100%`,background:`transparent`,border:`none`,borderLeft:e===n.id?`4px solid var(--cyan)`:`4px solid transparent`,padding:`12px 24px`,display:`flex`,alignItems:`center`,gap:`16px`,color:e===n.id?`#fff`:`#a1a1aa`,fontFamily:`var(--font-body)`,fontSize:`0.95rem`,cursor:`none`,textAlign:`left`,background:e===n.id?`rgba(34,211,238,0.05)`:`transparent`,transition:`all 0.2s`},children:[(0,x.jsx)(`span`,{style:{fontSize:`1.2rem`},children:n.icon}),n.label]},n.id)),(0,x.jsxs)(`div`,{style:{padding:`24px`,marginTop:`24px`,borderTop:`1px solid rgba(255,255,255,0.05)`},children:[(0,x.jsx)(`span`,{className:`font-mono`,style:{fontSize:`0.7rem`,color:`#71717a`,textTransform:`uppercase`,letterSpacing:`0.1em`},children:`Quick Launch`}),(0,x.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`12px`,marginTop:`16px`},children:ne.map(e=>(0,x.jsxs)(`button`,{onClick:()=>{r(e.id),t(`chat`)},style:{background:`transparent`,border:`none`,color:`#a1a1aa`,fontFamily:`var(--font-body)`,fontSize:`0.9rem`,display:`flex`,alignItems:`center`,gap:`8px`,cursor:`none`,textAlign:`left`,transition:`color 0.2s`},onMouseEnter:t=>t.currentTarget.style.color=e.color,onMouseLeave:e=>e.currentTarget.style.color=`#a1a1aa`,children:[(0,x.jsx)(`span`,{style:{width:`8px`,height:`8px`,borderRadius:`50%`,background:e.color}}),e.name]},e.id))})]})]}),(0,x.jsxs)(`div`,{style:{padding:`24px`,borderTop:`1px solid rgba(255,255,255,0.05)`,display:`flex`,alignItems:`center`,gap:`12px`},children:[(0,x.jsx)(`img`,{src:`/logo.png`,alt:`System Core`,style:{width:`40px`,height:`40px`,borderRadius:`50%`,border:`1.5px solid var(--cyan)`,boxShadow:`0 0 10px rgba(34,211,238,0.2)`}}),(0,x.jsxs)(`div`,{children:[(0,x.jsx)(`div`,{style:{fontSize:`0.9rem`},children:`Commander`}),(0,x.jsx)(`div`,{className:`font-mono`,style:{fontSize:`0.7rem`,color:`var(--cyan)`},children:`ONLINE`})]})]})]}),(0,x.jsx)(`main`,{className:`main-content`,style:{flex:1,marginLeft:`24px`,paddingBottom:`24px`,position:`relative`,zIndex:10,width:`100%`,minHeight:`100vh`},children:(0,x.jsx)(`div`,{style:{marginLeft:`240px`,width:`calc(100% - 240px)`},className:`main-content-inner`,children:i()})}),(0,x.jsx)(`style`,{dangerouslySetInnerHTML:{__html:`
          @media (max-width: 768px) {
            .main-content-inner {
        ...
        `}}),(0,x.jsx)(`nav`,{className:`mobile-nav`,style:{position:`fixed`,bottom:0,left:0,right:0,background:`rgba(2,4,8,0.85)`,backdropFilter:`blur(20px)`,borderTop:`1px solid rgba(255,255,255,0.05)`,padding:`12px 24px`,display:`flex`,justifyContent:`space-between`,alignItems:`center`,zIndex:100},children:a.map(n=>(0,x.jsxs)(`button`,{onClick:()=>t(n.id),style:{background:`transparent`,border:`none`,color:e===n.id?`var(--cyan)`:`#71717a`,fontSize:`1.5rem`,cursor:`none`,display:`flex`,flexDirection:`column`,alignItems:`center`,gap:`4px`},children:[(0,x.jsx)(`span`,{children:n.icon}),(0,x.jsx)(`span`,{className:`font-mono`,style:{fontSize:`0.6rem`},children:n.label})]},n.id))})]})]})}(0,y.createRoot)(document.getElementById(`root`)).render((0,x.jsx)(b.StrictMode,{children:(0,x.jsx)(le,{})}));